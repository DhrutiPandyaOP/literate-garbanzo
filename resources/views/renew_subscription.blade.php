                ...
                <table>
                  ...
                  <tr>
                    <td valign="top" bgcolor="#ffffff"
                        style="padding: 20px 40px 30px 40px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #757575;">
                    <?php
                    $date = new DateTime($message_body['activation_date']);
                    $activation_date= $date->format('M d, Y H:i:s T');
                    $exp_date = new DateTime($message_body['expiration_date']);
                    $expiration_date = $exp_date->format('M d, Y H:i:s T');
                    ?>
                    <!-- <p style="margin-top: 0; font-weight: bold;">Payment Received For Subscription Renewal</p> -->
                      <p style="margin: 0 0 20px;">Thank you for subscribing to the
                        <strong>{!! $message_body['subscription_name'] !!}</strong> with
                        PhotoADKing. This email is being sent to confirm that your
                        <strong>current_plan</strong> with <strong>transaction_id: [{!! $message_body['subscr_id'] !!}
                          ]</strong> has expired. Your latest plan
                        started on <strong>{!! $activation_date !!}</strong> and ended on
                        <strong>{!! $expiration_date !!}</strong>.</p>
                      <p style="margin: 0;">If you want to continue as a premium user, you can
                        renew the <strong>{!! $message_body['subscription_name'] !!}</strong> by tapping on the button
                        below.
                        If not, you’ll be
                        switched to a regular plan with zero access to premium resources.
                      </p>
                    </td>
                  </tr>
                  <tr>
                    <td bgcolor="#ffffff" style="text-align: center;">
                      <a href="{!! $message_body['invoice_url'] !!}"
                         style="background: #0069FF; border: 15px solid #0069FF; font-family: 'Montserrat', sans-serif; font-size: 14px; line-height: 1.1; text-align: center; text-decoration: none; display: inline-block; width:200px; border-radius: 50px; font-weight: bold;cursor: pointer !important;"
                         class="button-a">
                                                    <span style="color:#ffffff;" class="button-link">&nbsp;&nbsp;Confirm
                                                        Payment&nbsp;&nbsp;&nbsp;</span>
                      </a>
                    </td>
                  </tr>
                  <tr>
                    <td style="padding: 30px 40px 30px 40px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #757575; text-align: center;"
                        bgcolor="#ffffff">
                      <p style="margin-bottom: 25px; margin-top: 0;">Press the 'Confirm
                        payment’ button to process the payment. Continue the process on the
                        directed link, until you receive payment invoice. This will
                        indicate your <strong>{!! $message_body['subscription_name'] !!}</strong> is activated and is
                        successfully renewed with
                        the newest template resources. </p>
                      <p style="margin-bottom: 25px; margin-top: 0;"><span
                          style="text-decoration: underline;">Please note :</span> Only if
                        you
                        confirm the payment through the mentioned link, your renewal will be
                        considered.</p>
                    </td>
                  </tr>
                  <tr>
