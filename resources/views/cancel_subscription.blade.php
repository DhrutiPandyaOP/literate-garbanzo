...
<center style="width: 100%; background: #F1F1F1; text-align: left;">
  <div style="max-width: 680px; margin: auto; background: #ffffff;" class="email-container">
    ...
    <table role="presentation" cellspacing="0" cellpadding="0" bgcolor="#e4e4e4" border="0" align="center"
                ...
                <table>
                  <tr>
                    <td valign="top" style="text-align: center; padding: 30px 0 10px 0;"
                        bgcolor="#ffffff">
                      <h1 class="user_name"
                          style="text-transform: uppercase; margin: 0; font-family: 'Montserrat', sans-serif; font-size: 24px; line-height: 36px; color: #0069FF; font-weight: bold;word-break: break-word">
                        Hi
                  ...
                  <tr>
                    <td valign="top" bgcolor="#ffffff" class="td-pd"
                        style="text-align: center; padding: 20px 40px 15px 40px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #757575;">
                      <p style="margin-top:0; color: #5eaa46; font-size: 16px;">Your
                        subscription for <b>{!! $message_body['subscription_name'] !!}</b>
                        has been cancelled on <b><?php
                          $date = new DateTime($message_body['cancellation_date']);
                          $cancellation_date= $date->format('M d, Y H:i:s T');?>{!! $cancellation_date !!}</b>.</p>

                      <p>Allowing you no further access to <b>Premium Content</b> after <b><?php
                          $date = new DateTime($message_body['expiration_date']);
                          $expiration_date= $date->format('M d, Y H:i:s T');?>{!! $expiration_date !!}</b>,
                        You will be downgraded to a <b>Free Plan</b>.</p>
                    </td>
                  </tr>
                  <tr>
                    <td valign="top" bgcolor="#ffffff"
                      ...
                      <table align="center" border="1" cellpadding="0" cellspacing="0"
                             width="100%" style="background:#f7f9fa;padding:16px;border-radius:2px;overflow:hidden; border: 1px;
                                                    border-color: #eaeaed;">
                        <tbody>
                        <tr>
                          <td valign="top"
                              ...
                              <tr>
                                <td align="left" valign="top"
                                    style="border-collapse:collapse;text-transform:capitalize">
                                                                                <span
                                                                                  style="border-collapse:collapse;width:100%;display:block">
                                                                                    Total amount for
                                                                                </span>
                                  <span
                                    style="border-collapse:collapse;font-size:14px;width:100%;display:block;font-weight: bold;">
                                                                                    {!! $message_body['subscription_name'] !!}
                                                                                </span>
                                </td>
                                <td align="right" valign="middle"
                                    style="border-collapse:collapse;font-size:16px;font-weight:bold;">
                            ...
                            <table align="center" border="0" cellpadding="0"
                              ...
                              <tr>
                                ...
                                <td align="left" valign="top"
                                    ...
                                    <?php
                                    $date = new DateTime($message_body['cancellation_date']);
                                    $cancellation_date= $date->format('M d, Y H:i:s T');
                                    ?>
                                  {!! $cancellation_date !!} ({{ isset($message_body['cancellation_date_local']) ? $message_body['cancellation_date_local'] : "N/A" }})
                                </td>
                              </tr>
                              </tbody>
                            </table>
                            ...
                            <table align="center" border="0" cellpadding="0"
                              ...
                              <tr>
                                ...
                                <td align="left" valign="top"
                                    ...
                                    <?php
                                    $date = new DateTime($message_body['expiration_date']);
                                    $expiration_date= $date->format('M d, Y H:i:s T');
                                    ?>
                                  {!! $expiration_date !!} ({{ isset($message_body['expiration_date_local']) ? $message_body['expiration_date_local'] :"N/A" }})
                                </td>
                              </tr>
                              </tbody>
                            </table>
      ...
      <tr>
        <td
          style="padding: 40px 80px 40px 80px; font-family: sans-serif; font-size: 15px; line-height: 20px;  text-align: center;">
          <p style="margin: 0; font-weight:bold; color: #757575;">We are here if you need
            support</p>
          <p
            style="font-size: 12px !important; color:#909090; font-weight: 600; font-family: sans-serif;margin-bottom: 0">
            Email:
