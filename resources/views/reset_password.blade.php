                ...
                <table>
                  ...
                  <tr>
                    <td valign="top" bgcolor="#ffffff"
                      ...
                      <p style="margin: 0;">You recently requested to reset your password for
                        your PhotoADKing account. Click the button below to reset it.</p>
                    </td>
                  </tr>
                  <tr>
                    <td bgcolor="#ffffff" style="text-align: center;">
                      <a href="{!! $message_body['redirect_url'] !!}/{!! $message_body['email_id'] !!}/{!! $message_body['token'] !!}"
                         style="background: #0069FF; border: 15px solid #0069FF; font-family: 'Montserrat', sans-serif; font-size: 14px; line-height: 1.1; text-align: center; text-decoration: none; display: inline-block; width:200px; border-radius: 50px; font-weight: bold;cursor: pointer;"
                         class="button-a">
                                                    <span style="color:#ffffff;"
                                                          class="button-link">&nbsp;&nbsp;Reset
                                                        your password&nbsp;&nbsp;&nbsp;</span>
                      </a>
                    </td>
                  </tr>
                  <tr>
                    <td style="padding: 50px 40px 30px 40px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #757575; text-align: center;"
                        bgcolor="#ffffff">
                      <p style="margin-bottom: 25px; margin-top: 0;">If you
                        did not request a password reset,
                        please ignore this email. This password reset is only valid for the
                        next 60 minutes.</p>
                    </td>
                  </tr>
                  <tr>
