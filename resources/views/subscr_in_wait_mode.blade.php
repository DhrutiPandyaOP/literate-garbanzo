                ...
                <table>
                  ...
                  <tr>
                    <td valign="top" bgcolor="#ffffff"
                        style="padding: 20px 40px 20px 40px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #757575;">
                      <!-- <p style="margin-top: 0; font-weight: bold;">Payment Received For Subscription Renewal</p> -->
                      <p style="margin: 0; text-align: justify;">We have received your payment
                        request for
                        <strong>{!! $message_body['sub_type'] !!}</strong> with PhotoADKing performed on
                        <strong>{!! $message_body['activate_date'] !!}</strong>. This was to
                        inform you that we are currently encountering some kind of issue
                        with your transaction or payment gateway. It can be declined for a
                        variety of reasons:
                      </p>
                      <ul style="padding: 0 0 0 16px;">
                        <li>Incorrectly entered information</li>
                        <li>Different card issuance country</li>
                        <li>Too many payment attempts</li>
                        <li>and many more.</li>
                      </ul>
                      <p style="margin: 20px 0 0 0;">Still we’ll try to identify the expected
                        reason
                        and let you know. Within <span
                          style="text-decoration: underline;">24 hours</span>, you’ll
                        be notified about the
                        transaction status, issue and your next possible action.
                      </p>
                    </td>
                  </tr>
                  <tr>
                    <td bgcolor="#ffffff"
                        style="font-family: 'Montserrat', sans-serif; text-align: left; padding: 30px 15px 30px 40px; font-size: 13px; color: gray;">
