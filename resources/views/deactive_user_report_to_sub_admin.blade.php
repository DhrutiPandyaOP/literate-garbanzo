...
<center style="width: 100%; background: #F1F1F1; text-align: left;">
  <div style="width: 100%; background: #ffffff;" class="email-container">
                    ...
                    <tr>
                      <td valign="top" style="text-align: center; padding: 30px 0 10px 0;"
                        ...
                        <h2 style=" margin: 0; font-family: 'Montserrat', sans-serif; font-size: 16px; line-height: 36px; color: #0061d9; font-weight: bold;">
                          Below is the hourly total report of {!! $title !!}.
                        </h2>
                      </td>
                    </tr>
                    <tr>
                      <td valign="top" bgcolor="#ffffff"
                          style="text-align: center; font-family: 'Roboto', sans-serif; font-size: 15px; line-height: 20px;">
                        <div class="c-mob-responsive">
                          <table border="1" height="150px" class="c-mob-width">
                            <tr>
                              <th class="c-padding">User Id</th>
                              <th class="c-padding">First Name</th>
                              <th style="min-width: 300px;" class="c-padding">Email Id</th>
                              <th class="c-padding">Design Count</th>
                              <th class="c-padding">Video Design Count</th>
                              <th class="c-padding">Upload Image Count</th>
                              <th style="min-width: 250px;" class="c-padding">Last Login Time</th>
                            </tr>
                            @foreach($users_details as $user)
                              <tr>
                                <td>{!! $user->user_id !!}</td>
                                <td class="c-padding">{!! $user->first_name !!}</td>
                                <td>{!! $user->email_id !!}</td>
                                <td>{!! $user->my_design_count !!}</td>
                                <td>{!! $user->my_video_design_count !!}</td>
                                <td>{!! $user->uploaded_img_count !!}</td>
