              ...
              <td align="center" valign="top">
                <table border="0" cellspacing="0" cellpadding="0" width="100%">
                  ...
                  <div style="padding:10px;">
                    ...
                    <h2 style="text-align: center;">Weekly normal images search tag report </h2>
                        ...
                        @foreach($data['tags'] as $key => $row)
                          @if($key%2 == 0)
                            <tr style="border: 1px solid black; background-color: #d3d3d3;">
                              ...
                              <td
                                style="padding:.50rem;vertical-align: middle;text-align: left;">{{ isset($row->category_name) && $row->category_name !='' ? $row->category_name :'-' }}</td>
                              <td
