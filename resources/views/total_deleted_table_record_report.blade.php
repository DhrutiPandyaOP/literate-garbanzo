                  ...
                  <table>
                    <tr>
                      <td valign="top" style="text-align: center; padding: 30px 0 10px 0;"
                        ...
                        <h2 style=" margin: 0; font-family: 'Montserrat', sans-serif; font-size: 16px; line-height: 36px; color: #0061d9; font-weight: bold;">
                          Below is the daily report of delete extra record from table.
                        </h2>
                      </td>
                    </tr><br><br><br>
                    ...
                    <table border="1" width="500px" height="150px">
                      ...
                      <tr style="text-align: center;font-size: 20px;">
                        <td> {{ $message_body['user_registration_temp'] }}  </td>
                        <td> {{ $message_body['otp_codes'] }}  </td>
                        <td> {{ $message_body['user_pwd_reset_token_master'] }}  </td>
                        <td> {{ $message_body['failed_jobs'] }}  </td>
                        <td> {{ $message_body['failed_jobs_detail'] }}  </td>
                      </tr>
                    </table>
                    <tr>
