                ...
                <table>
                  <tr>
                    <td valign="top" style="text-align: center; padding: 30px 0 10px 0;"
                        bgcolor="#ffffff">
                      <h1 class="user_name" style="text-transform: uppercase; margin: 0; font-family: 'Montserrat', sans-serif; font-size: 24px; line-height: 36px; color: #0069FF; font-weight: bold;word-break: break-word">Hi
                  ...
                  <tr>
                    <td class="td-pd" valign="top" bgcolor="#ffffff" style="text-align: center; padding: 20px 40px 15px 40px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #757575;word-break: break-word">
                      <p style="margin-top:0; color: #5eaa46; font-size: 16px;"> Your payment
                        was successful!</p>
                      <p>{!! $message_body['message'] !!}</p>
                    </td>
                  </tr>
                  <tr>
                    <td valign="top" bgcolor="#ffffff" style="text-align: center; padding: 0 40px 40px 40px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #757575;">
                      <table align="center" border="1" cellpadding="0" cellspacing="0" width="100%"
                             style="background:#f7f9fa;padding:16px;border-radius:2px;overflow:hidden; border: 1px;
                                                    border-color: #eaeaed;">
                        <tbody>
                        <tr>
                          <td valign="top" style="text-align: center; padding: 20px 20px 20px 20px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #757575;">
                            <p style="margin: 0; font-size: 18px;">Receipt
                              details</p>
                          </td>
                        </tr>
                        <tr>
                          <td align="left" valign="middle" style="border-collapse:collapse;padding: 8px;border-bottom:1px solid #eaeaed">
                            <table align="center" border="0" cellpadding="0"
                                   cellspacing="0" width="100%">
                              <tbody>
                              <tr>
                                <td align="left" valign="top" style="border-collapse:collapse;text-transform:capitalize;font-family: sans-serif;">
                                ...
                                <td align="right" valign="middle" style="border-collapse:collapse;font-size:16px;font-weight:bold;font-family: sans-serif;">
                        ...
                        @if(isset($message_body['subscr_id']))
                        <tr>
                          <td align="left" valign="middle" style="border-collapse:collapse;padding:8px;border-bottom:1px solid #eaeaed;font-size:12px">
                            <table align="center" border="0" cellpadding="0"
                                   cellspacing="0" width="100%">
                          ...
                          <td align="left" valign="middle" style="border-collapse:collapse;padding:8px;border-bottom:1px solid #eaeaed;font-size:12px">
                            <table align="center" border="0" cellpadding="0"
                              ...
                              <tr>
                                ...
                                <td width="16" align="left" valign="top"
                                    style="border-collapse:collapse;font-weight:normal;font-family: sans-serif; font-size: 12px;">:</td>
                                <td align="left" valign="top" style="border-collapse:collapse;font-weight:normal; font-size:16px;color:#5eaa46;font-family: sans-serif;">
                        ...
                        @if(isset($message_body['activation_date']))
                        <tr>
                          <td align="left" valign="middle" style="border-collapse:collapse;padding:8px;border-bottom:1px solid #eaeaed;font-size:12px">
                            <table align="center" border="0" cellpadding="0"
                                   cellspacing="0" width="100%">
                              ...
                              <tr>
                                ...
                                <td align="left" valign="top" style="border-collapse:collapse;font-weight:normal;font-family: sans-serif; font-size: 12px;">
                                    ...
                                    ?>
                                  {!! $activation_date !!} ({{ isset($message_body['activation_date_local']) ? $message_body['activation_date_local'] : "N/A" }})
                                </td>
                              </tr>
                              </tbody>
                            </table>
                        ...
                        @endif
                        @if(isset($message_body['next_billing_date']))
                        <tr>
                          <td align="left" valign="middle" style="border-collapse:collapse;padding:8px;border-bottom:1px solid #eaeaed;font-size:12px">
                            <table align="center" border="0" cellpadding="0"
                                   cellspacing="0" width="100%">
                              ...
                              <tr>
                                ...
                                <td align="left" valign="top" style="border-collapse:collapse;font-weight:normal;font-family: sans-serif; font-size: 12px;">
                                    <?php
                                    $date = new DateTime($message_body['next_billing_date']);
                                    $next_billing_date = $date->format('M d, Y H:i:s T');
                                    ?>Near about {!! $next_billing_date !!} ({{ isset($message_body['next_billing_date_local']) ? $message_body['next_billing_date_local'] : "N/A" }})
                                </td>
                              </tr>
                              </tbody>
                            </table>
                        ...
                        @endif
                        <?php if(isset($message_body['invoice_url'])){ ?>
                        <tr>
                          <td align="left" valign="middle" style="border-collapse:collapse;padding:8px;border-bottom:1px solid #eaeaed;font-size:12px">
                            <table align="center" border="0" cellpadding="0"
                                   cellspacing="0" width="100%">
