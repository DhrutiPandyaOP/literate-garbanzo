    ...
    <table role="presentation" cellspacing="0" cellpadding="0" bgcolor="#e4e4e4" border="0" align="center"
                ...
                <table>
                  <tr>
                    <td valign="top" style="text-align: center; padding: 30px 0 10px 0;"
                        bgcolor="#ffffff">
                      <h1 class="user_name" style="text-transform: uppercase; margin: 0; font-family: 'Montserrat', sans-serif; font-size: 24px; line-height: 36px; color: #0069FF; font-weight: bold;word-break: break-word">
                        Hi
                        {!! $message_body['first_name'] !!}</h1>
                    </td>
                  </tr>
                  <tr>
                    <td valign="top" bgcolor="#ffffff" class="td-pd"
                        style="text-align: center; padding: 20px 40px 15px 40px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #757575;word-break: break-word">
                      <p style="margin-top:0; color: #f50606; font-size: 16px;"> Your payment
                        failed!</p>
                  ...
                  <tr>
                    <td valign="top" bgcolor="#ffffff"
                        style="text-align: center; padding: 0 40px 40px 40px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #757575;">
                      <table align="center" border="1" cellpadding="0" cellspacing="0"
                             width="100%"
                             style="background:#f7f9fa;padding:16px;border-radius:2px;overflow:hidden; border: 1px;
                                                    border-color: #eaeaed;">
                        <tbody>
                        <tr>
                          <td valign="top"
                              style="text-align: center; padding: 20px 20px 20px 20px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #757575;">
                            <p style="margin: 0; font-size: 18px;">Receipt
                              details</p>
                          </td>
                        </tr>
                        <tr>
                          <td align="left" valign="middle"
                              style="border-collapse:collapse;padding: 8px;border-bottom:1px solid #eaeaed">
                            <table align="center" border="0" cellpadding="0"
                                   cellspacing="0" width="100%">
                              <tbody>
                              <tr>
                                <td align="left" valign="top"
                                    style="border-collapse:collapse;text-transform:capitalize;font-family: sans-serif;">
                                                                                <span style="border-collapse:collapse;width:100%;display:block;font-family: sans-serif;">
                                                                                    Total amount for
                                                                                </span>
                                  <span style="border-collapse:collapse;font-size:14px;width:100%;display:block;font-weight: bold;font-family: sans-serif;">
                                                                                    {!!
                                                                                    $message_body['subscription_name']
                                                                                    !!}
                                                                                </span>
                                </td>
                                <td align="right" valign="middle"
                                    style="border-collapse:collapse;font-size:16px;font-weight:bold;font-family: sans-serif;">
                                  {!! $message_body['total_amount'] !!}
                                  {!! strtoupper($message_body['mc_currency']) !!}
                                </td>
                              </tr>
                              </tbody>
                            </table>
                        ...
                        <tr>
                          <td align="left" valign="middle"
                              style="border-collapse:collapse;padding:8px;border-bottom:1px solid #eaeaed;font-size:12px">
                            <table align="center" border="0" cellpadding="0"
                                   cellspacing="0" width="100%">
                              <tbody>
                              <tr>
                                ...
                                <td width="16" align="left" valign="top"
                                    style="border-collapse:collapse;font-weight:normal;font-family: sans-serif; font-size: 12px;">
                                  :
                                </td>
                                <td align="left" valign="top"
                                    style="border-collapse:collapse;font-weight:normal;font-family: sans-serif; font-size: 12px;">
                                  {!! $message_body['payment_received_from'] !!}
                                </td>
                              </tr>
                              </tbody>
                            </table>
                            ...
                            <table align="center" border="0" cellpadding="0"
                              ...
                              <tr>
                                ...
                                <td align="left" valign="top"
                                  ...
                                  {!! $message_body['total_amount'] !!}
                                  {!! strtoupper($message_body['mc_currency']) !!}
                                  {{ isset($message_body['tax_amount']) ? $message_body['tax_amount'] : "" }}
                                </td>
                              </tr>
                              </tbody>
                            </table>
                        ...
                        <?php if(isset($message_body['txn_id'])) { ?>
                        <tr>
                          <td align="left" valign="middle"
                              style="border-collapse:collapse;padding:8px;border-bottom:1px solid #eaeaed;font-size:12px">
                            <table align="center" border="0" cellpadding="0"
                          ...
                          <td align="left" valign="middle"
                            ...
                            <table align="center" border="0" cellpadding="0"
                              ...
                              <tr>
                                ...
                                <td align="left" valign="top"
                                    style="border-collapse:collapse;font-weight:normal; font-size:16px;color:#5eaa46;font-family: sans-serif;">
                                  {!! $message_body['payment_status'] !!}
                                </td>
                              </tr>
                              </tbody>
                            </table>
                        ...
                        @if(isset($message_body['phone']) && isset($message_body['address']))
                          <tr>
                            <td align="left" valign="middle" style="border-collapse:collapse;padding:8px;border-bottom:1px solid #eaeaed;font-size:12px">
                              <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tbody>
                                  <tr>
                                    <td width="40%" align="left" valign="top" style="border-collapse:collapse;text-transform:capitalize;font-family: sans-serif; font-size: 12px;">Contact No</td>
                                    <td width="16" align="left" valign="top" style="border-collapse:collapse;font-weight:normal;font-family: sans-serif; font-size: 12px;">:</td>
                                    <td align="left" valign="top" style="border-collapse:collapse;font-weight:normal;font-family: sans-serif; font-size: 12px;">{!! $message_body['phone'] !!}</td>
                                  </tr>
                                </tbody>
                              </table>
                            </td>
                          ...
                          <tr>
                            <td align="left" valign="middle" style="border-collapse:collapse;padding:8px;border-bottom:1px solid #eaeaed;font-size:12px">
                              <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tbody>
                                  <tr>
                                    <td width="40%" align="left" valign="top" style="border-collapse:collapse;text-transform:capitalize;font-family: sans-serif; font-size: 12px;">Address</td>
                                    <td width="16" align="left" valign="top" style="border-collapse:collapse;font-weight:normal;font-family: sans-serif; font-size: 12px;">:</td>
                                    <td align="left" valign="top" style="border-collapse:collapse;font-weight:normal;font-family: sans-serif; font-size: 12px;">{!! $message_body['address'] !!}</td>
                                  </tr>
                                </tbody>
                              </table>
                            </td>
                        ...
                        @if(isset($message_body['user_account_url']) && isset($message_body['how_to_update_payment_method']))
                          <tr>
                            <td align="left" valign="middle"
                                style="border-collapse:collapse;padding:8px;border-bottom:1px solid #eaeaed;font-size:12px">
                              <table align="center" border="0" cellpadding="0"
                                ...
                                <tr>
                                  ...
                                  <table role="presentation"
                                    ...
                                    <tr>
                                      <td style="border-radius: 50px; background: #1D82FF; text-align: center;"
                                          class="button-td">
                                        <a id="activate-account"
                                           href="{!! $message_body['user_account_url'] !!}"
                                           style="background: #95CE0B; padding: 10px 10px; font-family: 'Montserrat', sans-serif; font-size: 14px; line-height: 1.1; text-align: center; text-decoration: none; display: block; border-radius: 50px; font-weight: bold;cursor: pointer;"
                                           class="button-a"
                                           target="_blank">
                                            <span
                                                    style="color:#ffffff;"
                                                    class="button-link">&nbsp;&nbsp;&nbsp;&nbsp;Update Payment Method&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                        </a>
                                      </td>
                                    </tr>
                                  </table>
                            ...
                            <td align="left" valign="middle"
                              ...
                              <table align="center" border="0" cellpadding="0"
                                ...
                                <tr>
                                  ...
                                  <td align="left" valign="top"
                                      style="border-collapse:collapse;font-weight:normal;font-family: sans-serif; font-size: 12px;">
                                    {!! $message_body['how_to_update_payment_method'] !!}
                                  </td>
                                </tr>
                                </tbody>
                              </table>
      ...
      <tr>
        <td style="padding: 40px 80px 40px 80px; font-family: sans-serif; font-size: 15px; line-height: 20px;  text-align: center;">
          ...
          <p style="font-size: 12px !important; color:#909090; font-weight: 600; font-family: sans-serif;margin-bottom: 0">
            Email:
