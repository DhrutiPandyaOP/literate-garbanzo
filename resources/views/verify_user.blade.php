    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="680" align="center">
      <tr>
        <td>
          <!--[endif]-->
          <!-- Email Body : BEGIN -->
          <table role="presentation" cellspacing="0" cellpadding="0" bgcolor="#ffffff" border="0"
                 align="center" width="100%" style="max-width: 680px;" class="email-container">
            <!-- HEADER : BEGIN -->
            <tr>
                ...
                <table border="0" cellspacing="0" cellpadding="0" width="100%">
                  ...
                  <tr>
                    <td align="center" valign="middle">
                      <table border="0" cellspacing="0" cellpadding="0" width="100%">
                        ...
                        <tr>
                          <td align="center" valign="middle"
                              style="padding-top:15px" class="hder-td">
                            <img src="https://d3jmn01ri1fzgl.cloudfront.net/photoadking/static_assets/email/ml-hdr-logo.png"
                                 ...
                                 title="PhotoADKing" class="hdr-logo">
                          </td>
                        </tr>
                        </tbody>
                      </table>
                  ...
                  <tr>
                    <td style="text-align: center">
                      <table role="presentation" cellspacing="0" align="center"
                    ...
                    <tr>
                      <td align="center" valign="middle" width="500">
                        ...
                        <table role="presentation" border="0" cellpadding="0"
                          ...
                          <tr>
                            <td height="40" style="font-size:20px; line-height:20px;">
                              &nbsp;</td>
                          </tr>
                          <tr>
                            <td align="center" valign="middle">
                              <table>
                                <tr>
                                  <td valign="top"
                                      style="text-align: center; padding: 30px 0 10px 0;"
                                      bgcolor="#ffffff">
                                    <h1
                                      style="text-transform: uppercase; margin: 0; font-family: 'Montserrat', sans-serif; font-size: 24px; line-height: 36px; color: #0069FF; font-weight: bold;">
                                      WELCOME
                                      {!! $message_body['first_name'] !!}
                                    </h1>
                                  </td>
                                </tr>
                                <tr>
                                  <td valign="top" bgcolor="#ffffff"
                                    ...
                                    <p
                                      ...
                                      Thank you for
                                      registering with PhotoADKing.
                                    </p>
                                    <p style="margin: 0;">You are just one step
                                      away from activating
                                      your account on PhotoADKing! Click on
                                      the button to complete
                                      email verification and start your
                                      designing.
                                    </p>
                                  </td>
                                </tr>
                                        ...
                                        <tr>
                                          <td style="border-radius: 50px; background: #1D82FF; text-align: center;"
                                            ...
                                            <a id="activate-account"
                                               href="{!! $message_body['redirect_url'] !!}/{!! $message_body['user_registration_temp_id'] !!}/{!! $message_body['token'] !!}"
                                               style="background: #0069FF; border: 15px solid #0069FF; font-family: 'Montserrat', sans-serif; font-size: 14px; line-height: 1.1; text-align: center; text-decoration: none; display: block; border-radius: 50px; font-weight: bold;cursor: pointer;"
                                               class="button-a"
                                               target="_blank">
                                                                                                <span
                                                                                                  style="color:#ffffff;"
                                                                                                  class="button-link">&nbsp;&nbsp;&nbsp;&nbsp;Activate
                                                                                                    Account&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                            </a>
                                          </td>
                                        </tr>
            ...
            <tr>
              <td>
                <table role="presentation" cellspacing="0" cellpadding="0" border="0"
                       style="max-width:500px; margin: auto;">
                  <tr>
                    <td style="padding: 20px 40px 40px 40px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #757575; text-align: center;"
                        bgcolor="#ffffff">
                      <p style="margin: 0;">If you did not create an account using this
                        address, please
                        ignore this email.
                      </p>
                    </td>
            ...
            <tr>
              <td bgcolor="#dbdbdb">
                <table role="presentation" cellspacing="0" cellpadding="0" border="0"
                  ...
                  <tr>
                    <td
                      style="padding: 40px 40px 40px 40px; font-family: sans-serif; font-size: 15px; line-height: 20px;  text-align: center;">
                      <p style="margin: 0; font-weight:bold; color: #757575 !important;">We
                        are here if you need
                        support
                      </p>
                      <p
                        style="font-size: 12px !important; color:#909090 !important; font-weight: 600; font-family: sans-serif;margin-bottom: 0">
                        Email:
                        help@photoadking.com
                      </p>
                    </td>
                  </tr>
                </table>
