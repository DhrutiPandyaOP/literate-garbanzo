                ...
                <table>
                  ...
                  <tr>
                    <td valign="top" bgcolor="#ffffff"
                        style="padding: 20px 40px 10px 40px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #757575;">
                      <!-- <p style="margin-top: 0; font-weight: bold;">Payment Received For Subscription Renewal</p> -->
                      <p style="margin: 0 0 20px;">Thank you for lending us time to identify
                        the issue with your transaction. The payment done on the
                        <strong>{!! $message_body['activation_date'] !!}</strong> is found to be cancelled due to
                        <strong><span>"</span>{!! $message_body['decline_reason'] !!}<span>"</span></strong>. No
                        withdrawal is done from your account; visit your bank to verify the
                        transaction status of your account. </p>
                      <p style="margin: 0;">Verify the below info :</p>
                      <p style="margin-bottom: 0;">User id : <strong>{!! $message_body['email_id'] !!}</strong></p>
                      <p style="margin: 0;">Subscr id : <strong>{!! $message_body['subscr_id'] !!}</strong></p>

                    </td>
                  </tr>
                  <tr>
                    <td valign="top" bgcolor="#ffffff"
                        style="padding: 0px 40px 10px 40px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #757575;">
                      <p>Issue is recognized for entering incorrect payment details, so you
                        can tap on the given link to update your billing information and
                        process the payment method with a valid mode of payment.</p>
                      <a style="color: #0069FF" target="_blank"
                         href="https://photoadking.com/app/#/account/billing-info">https://photoadking.com/app/#/account/billing-info</a>
                    </td>
                  </tr>
                  <tr>
                    <td valign="top" bgcolor="#ffffff"
                        style="padding: 0px 40px 0px 40px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #757575;">
                      <p>You’ll get notified after the transaction is complete. Your plan will
                        get activated as soon as payment is made successful. </p>
                    </td>
                  </tr>
                  <tr>
                    <td bgcolor="#ffffff"
