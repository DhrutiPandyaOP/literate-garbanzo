                ...
                <table>
                  ...
                  <tr>
                    <td valign="top" bgcolor="#ffffff" class="td-pd"
                        style="text-align: center; padding: 20px 40px 40px 40px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #757575;word-break: break-word">
                      <p style="margin-top: 0; font-weight: bold;"></p>
                      <p style="margin: 0;">
                        {!! $message_body['message'] !!}</p>
                      <br><a
                        href="help@photoadking.com?subject=Help%20us%20improve%20PhotoADKing"
                        class="button button--green"
                        style="font-family: sans-serif; font-size: 15px; line-height: 20px; color: #f5f5f5; ">Reply
                        Now</a></p>
                    </td>
                  </tr>
                  <tr>
