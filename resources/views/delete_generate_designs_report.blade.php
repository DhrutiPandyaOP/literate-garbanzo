                        ...
                        <table>
                          <tr>
                            <td valign="top" bgcolor="#ffffff"
                                style="text-align: center; padding: 20px 20px 0px 20px; font-family: sans-serif; font-size:14px !important; line-height: 20px; color: #757575;">
                              <p style="margin-top: 0; font-weight: bold;">Total count of deleted designs from server,Which are generated by user before 24 hours. By runing scheduler.</p>
                            </td>
                          </tr>
                          <tr>
                            <td valign="top" style="text-align: center; padding: 20px 0 10px 0;"
                                bgcolor="#ffffff">

                              <h1 style="text-transform: uppercase; margin: 0; font-family: 'Montserrat', sans-serif; font-size: 20px; line-height: 36px; color: #3c3a3a; font-weight: bold;">
                ...
                <table role="presentation" cellspacing="0" cellpadding="0"
                  ...
                  <tr>
                    <td
                      ...
                      <p style="margin: 0;">Copyright &copy; {{ date('Y') }}
