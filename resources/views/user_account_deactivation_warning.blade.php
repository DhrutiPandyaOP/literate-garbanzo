                  ...
                  <table>
                    <tr>
                      <td valign="top" style="text-align: center; padding: 30px 0 10px 0;"
                          bgcolor="#ffffff">
                        <h1 style="text-transform: uppercase; margin: 0; font-family: 'Montserrat', sans-serif; font-size: 24px; line-height: 36px; color: #0069FF; font-weight: bold;">
                          Hello, {!! $message_body['user_name'] !!}
                        </h1>
                      </td>
                    </tr>
                    <tr>
                      <td valign="top" bgcolor="#ffffff" style="text-align: center; padding: 20px 20px 0px 20px; font-family: sans-serif; font-size: 14px; line-height: 20px; color: #757575;">
                        <p style="margin-top: 0; font-weight: bold;">We noticed that you haven't used PhotoADKing in a while. To Keep your account active and your design up-to-date, just sign in.</p>
                      </td>
                    </tr>
                    <tr>
                      <td valign="top" bgcolor="#ffffff" align="center"
                          style="text-align: center; padding: 15px 0px 15px 0px;">
                            ...
                            <tr>
                              <td style="border-radius: 50px; background: #1D82FF; text-align: center;"
                                ...
                                <a href="https://photoadking.com/app/#/login"
                                   ...
                                   class="button-a btn-sign-in" target="_blank">
                                    <span style="color:#ffffff;"
                                          class="button-link">&nbsp;&nbsp;&nbsp;&nbsp;Sign in to PhotoADKing&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                </a>
                              </td>
                            </tr>
                          </table>
                    ...
                    <tr>
                      <td valign="top" bgcolor="#ffffff" style="text-align: center; padding: 20px 20px 0px 20px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #757575;">
                        <p style="margin: 0;">
                          If you have any additional information that you think will help us to assist you, please feel free to contact us. Click on the button below to reply.
                        </p>
                      </td>
                    </tr>
                    <tr>
                        ...
                        <center>
                          <table role="presentation" align="center" cellspacing="0"
                            ...
                            <tr>
                              <td style="border-radius: 50px; background: #1D82FF; text-align: center;"
                                  class="button-td">
                                <a href="https://photoadking.com/legal-information/contact/"
                                   style="background: #FFF; border: 1px solid #B3B3B3; font-family: 'Montserrat', sans-serif; font-size: 14px; line-height: 1.1; text-align: center; text-decoration: none; display: block; border-radius: 50px; font-weight: normal; cursor: pointer; padding: 10px;"
                                   class="button-a button-contact-us" target="_blank">
                                    <span style="color:#808080;"
                                          class="button-link">&nbsp;&nbsp;&nbsp;&nbsp;Contact Us&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                </a>
                              </td>
                            </tr>
                          </table>
