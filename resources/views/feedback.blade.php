...
<head>
  ...
  <style>
    ...
    .button {
      ...
      border-right: 30px solid #3869D4;
      border-bottom: 5px solid #3869D4;
      border-left: 30px solid #3869D4;
                ...
                <table style="border-spacing: 0;">
                  ...
                  <tr>
                    <td valign="top" bgcolor="#ffffff" class="td-pd"
                        style="text-align: left; padding: 20px 40px 00px 40px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #757575;">
                      <p style="margin-top: 0; font-weight: bold;"></p>
                      <p style="margin: 0;word-break: break-word">
                        Feedback from <b>{!! $message_body['send_by'] !!},</b></p>
                    </td>
                  </tr>
                  <tr>
                    <td valign="top" bgcolor="#ffffff" class="td-pd"
                        style="text-align: left; padding: 00px 40px 00px 60px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #757575;word-break: break-word">
                      <p style="margin-top: 0; font-weight: bold;word-break: break-word"></p>
                      <b>User email address:</b> {!! $message_body['email_id'] !!}
                    </td>
                  </tr>
                  <tr>
                    <td valign="top" bgcolor="#ffffff" class="td-pd"
                        style="text-align: left; padding: 00px 40px 00px 60px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #757575;word-break: break-word">
                      <p style="margin-top: 0; font-weight: bold;word-break: break-word"></p>
                      <b>Feedback text:</b> {!! $message_body['message'] !!}
                    </td>
                  </tr>
                  <tr>
                    <td valign="top" bgcolor="#ffffff" class="td-pd"
                        style="text-align: left; padding: 00px 40px 00px 60px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #757575;">
                      <p style="margin-top: 0; font-weight: bold;word-break: break-word"></p>
                      <b>Feedback rating:</b> {!! $message_body['rate'] !!}
                    </td>
                  </tr>
                  <tr>
                    <td bgcolor="#ffffff"
            ...
            <tr>
              <td>
                <a href="https://www.facebook.com/Photoadking-2194363387447211/"
                   target="_blank">
                  <img class="icn" src="https://d3jmn01ri1fzgl.cloudfront.net/photoadking/static_assets/email/f-icon.png" />
                </a>
              </td>
              <td width="10">&nbsp;</td>
              <td>
                <a href="https://www.instagram.com/photoadking/" target="_blank">
                  <img class="icn" src="https://d3jmn01ri1fzgl.cloudfront.net/photoadking/static_assets/email/i-icon.png" />
                </a>
              </td>
              <td width="10">&nbsp;</td>
              <td>
                <a href="https://www.pinterest.com/photoadking/" target="_blank">
                  <img class="icn" src="https://d3jmn01ri1fzgl.cloudfront.net/photoadking/static_assets/email/p-icon.png" />
                </a>
              </td>
              <td width="10">&nbsp;</td>
              <td>
                <a href="https://twitter.com/photoadking" target="_blank">
                  <img class="icn" src="https://d3jmn01ri1fzgl.cloudfront.net/photoadking/static_assets/email/t-icon.png" />
                </a>
              </td>
              <td width="10">&nbsp;</td>
              <td>
                <a href="https://www.youtube.com/channel/UCySoQCLtZI23JVqnsCyPaOg"
                   target="_blank">
                  <img class="icn" src="https://d3jmn01ri1fzgl.cloudfront.net/photoadking/static_assets/email/y-icon.png" />
                </a>
              </td>
