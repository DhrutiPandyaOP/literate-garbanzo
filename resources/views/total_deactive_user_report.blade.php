                  ...
                  <table>
                    ...
                    <tr>
                      <td valign="top" bgcolor="#ffffff" style="text-align: center; padding: 20px 20px 15px 20px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #757575;">
                        <p style="margin-top: 0; font-weight: bold;">The total warning mail sent to deactivated user report of last month is in the zip file, Which is attached with this mail.</p>
                      </td>
                    </tr>
                    <tr>
