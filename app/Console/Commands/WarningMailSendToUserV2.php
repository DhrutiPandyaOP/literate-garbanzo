    ...
    try {
      ...
      if (count($users) > 0) {
        ...
        foreach ($users as $user) {
          ...
          $data = array('template' => $template, 'email' => $user->email_id, 'subject' => $subject, 'message_body' => $message_body);
        ...
        $data = array('template' => $template, 'subject' => $subject, 'users_details' => $users_detail, 'title' => 'Warning Mail Send To User');
