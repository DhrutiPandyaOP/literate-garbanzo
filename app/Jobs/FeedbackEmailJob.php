...
class FeedbackEmailJob extends Job implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $data = ['template' => $template, 'email' => $email_id, 'admin_email_id' => $admin_email_id, 'super_admin_email_id' => $super_admin_email_id, 'subject' => $subject, 'message_body' => $message_body];
