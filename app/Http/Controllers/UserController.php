  ...
  public function uploadFontByUser(Request $request_body)
  {
    try {
      ...
      if (!$request_body->hasFile('font_file')) {
        return Response::json(array('code' => 201, 'message' => 'Required field font_file is missing or empty.', 'cause' => '', 'data' => json_decode("{}")));
      } else {
        ...
        if ($font_info['is_exist'] != 1) {
          ...
          if (count($is_exist) == 0) {
            ...
            return $response = Response::json(array('code' => 201, 'message' => 'Font already exist.', 'cause' => '', 'data' => json_decode("{}")));
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Font uploaded successfully.', 'cause' => '', 'data' => ['total_record' => count($uploaded_fonts), 'result' => $uploaded_fonts]));

    } catch (Exception $e) {
      (new ImageController())->logs("uploadFontByUser",$e);
//      Log::error("uploadFontByUser : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'upload font.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
  ...
  public function increaseFontUploadCount($user_id)
  {
    try {
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Font uploaded successfully.', 'cause' => '', 'data' => json_decode('{}')));
    } catch (Exception $e) {
      (new ImageController())->logs("increaseFontUploadCount",$e);
//      Log::error("increaseFontUploadCount : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'increase font upload count.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
    ...
    try {
      ...
      if (!Cache::has("Config::get('constant.REDIS_KEY'):getMyUploadedFonts$this->user_id")) {
        $result = Cache::rememberforever("getMyUploadedFonts$this->user_id", function () {
          ...
          return array('total_record' => count($uploaded_fonts), 'result' => $uploaded_fonts);
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Fonts fetched successfully.', 'cause' => '', 'data' => $redis_result));
      $response->headers->set('Cache-Control', Config::get('constant.RESPONSE_HEADER_CACHE'));

    } catch (Exception $e) {
      (new ImageController())->logs("getMyUploadedFonts",$e);
//      Log::error("getMyUploadedFonts : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'get my uploaded fonts.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
  ...
  public function deleteMyUploadedFontById(Request $request_body)
  {
    try {
      ...
      if (($response = (new VerificationController())->validateRequiredParameter(array('uploaded_font_id'), $request)) != '')
        return $response;
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Font deleted successfully.', 'cause' => '', 'data' => ['total_record' => count($uploaded_fonts), 'result' => $uploaded_fonts]));
  ...
  public function getAllFonts(Request $request)
  {
    ...
    try {
      ...
      $redis_result = Cache::rememberforever("getAllFonts:$this->sub_category_id:$this->page:$this->item_count", function () {
        ...
        return array('total_record' => $total_row, 'is_next_page' => $is_next_page, 'result' => $fonts_list);
...
//      Log::error("getAllFonts : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
  ...
  public function uploadImage(Request $request_body)
  {
    try {
      ...
      if (($response = (new VerificationController())->validateRequiredParameter(array('unique_id', 'chunks', 'chunk'), $request_body)) != '')
        return $response;
      ...
      if (is_object($response['data'])) {
        ...
        $response = Response::json(array('code' => 200, 'message' => 'File uploaded successfully.', 'cause' => '', 'data' => ['result' => $image_detail, 'upload_limit' => $upload_limit]));
      }

    } catch (Exception $e) {
      (new ImageController())->logs("uploadImage", $e);
      //Log::error("uploadImage : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => config('constant.EXCEPTION_ERROR') . 'upload image.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
  ...
  public function uploadImageByUser(Request $request_body)
  {
    try {
      ...
      $success_response = $image_list = array();
      ...
      if (!is_array($total_image_array) ) {
        return Response::json(array('code' => 201, 'message' => 'Required field file is accept only array.', 'cause' => '', 'data' => json_decode("{}")));
      }
...
//            $exception_response .= Response::json(array('code' => 201, 'message' => 'Something went wrong.Please try again.', 'cause' => '', 'data' => $image_array ));
      ...
      if($exception_response != NULL){
        $response = Response::json(array('code' => 417, 'message' => 'This image can not uploaded.', 'cause' => '', 'data' => $exception_response));
      }else{
        $response = Response::json(array('code' => 200, 'message' => 'Image uploaded successfully.', 'cause' => '', 'data' => ['success_response' => $success_response, 'upload_limit' => $upload_limit, 'result' => $image_list]));
      }

    } catch (Exception $e) {
      (new ImageController())->logs("uploadImageByUser",$e);
//      Log::error("uploadImageByUser : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'upload image.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
  ...
  public function increaseFileSize($user_id, $image_size)
  {
    try {
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Image uploaded successfully.', 'cause' => '', 'data' => json_decode('{}')));
    } catch (Exception $e) {
      (new ImageController())->logs("increaseFileSize",$e);
//      Log::error("increaseFileSize : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'increase file size.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
    ...
    try {
      ...
      if (!Cache::has("Config::get('constant.REDIS_KEY'):getMyUploadedImages$this->user_id:$this->page:$this->item_count")) {
        $result = Cache::rememberforever("getMyUploadedImages$this->user_id:$this->page:$this->item_count", function () {
          ...
          $is_next_page = ($total_row > ($this->offset + $this->item_count)) ? true : false;
          return array('upload_limit' => $upload_limit,'total_record' => $total_row, 'is_next_page' => $is_next_page, 'result' => $image_list);
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Images fetched successfully.', 'cause' => '', 'data' => $redis_result));
      $response->headers->set('Cache-Control', Config::get('constant.RESPONSE_HEADER_CACHE'));

    } catch (Exception $e) {
      (new ImageController())->logs("getMyUploadedImages",$e);
//      Log::error("getMyUploadedImages : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'get my uploaded images.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
  ...
  public function deleteMyUploadedImageById(Request $request_body)
  {
    try {
      ...
      $request = json_decode($request_body->getContent());
      if (($response = (new VerificationController())->validateRequiredParameter(array('upload_id'), $request)) != '')
        return $response;
...
//      Log::error("deleteMyUploadedImageById : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
  ...
  public function createMyDesignFolder(Request $request_body)
  {
    try {
      ...
      $request = json_decode($request_body->getContent());
      if (($response = (new VerificationController())->validateRequiredParameter(array('content_type', 'folder_name'), $request)) != '')
        return $response;
      ...
      if (count($is_exist) > 0) {
        return Response::json(array('code' => 201, 'message' => 'A folder with the same name already exist.', 'cause' => '', 'data' => json_decode("{}")));
      }
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Folder created successfully.', 'cause' => '', 'data' => $result));

    } catch (Exception $e) {
      (new ImageController())->logs("createMyDesignFolder", $e);
      //Log::error("createMyDesignFolder : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'create folder.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
  ...
  public function editMyDesignFolder(Request $request_body)
  {
    try {
      ...
      $request = json_decode($request_body->getContent());
      if (($response = (new VerificationController())->validateRequiredParameter(array('folder_id', 'folder_name'), $request)) != '')
        return $response;
      ...
      if (!$status) {
        return Response::json(array('code' => 201, 'message' => 'Folder does not exist.', 'cause' => '', 'data' => json_decode('{}')));
      }
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Folder name updated successfully.', 'cause' => '', 'data' => json_decode(json_encode($result))));

    } catch (Exception $e) {
      (new ImageController())->logs("editMyDesignFolder", $e);
      //Log::error("editMyDesignFolder : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'update folder.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
  ...
  public function removeMyDesignFolder(Request $request_body)
  {
    try {
      ...
      $request = json_decode($request_body->getContent());
      if (($response = (new VerificationController())->validateRequiredParameter(array('folder_id'), $request)) != '')
        return $response;
      ...
      if (count($design_list) <= 0) {
        return Response::json(array('code' => 201, 'message' => 'A folder with this name does not exist.', 'cause' => '', 'data' => json_decode("{}")));
      }
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Folder deleted successfully.', 'cause' => '', 'data' => json_decode('{}')));

    } catch (Exception $e) {
      (new ImageController())->logs("removeMyDesignFolder",$e);
//      Log::error("removeMyDesignFolder : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'delete folder.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
  ...
  public function removeDesignLists(Request $request_body)
  {
    try {
      ...
      if ($folder_ids != '') {
        ...
        if (isset($image_list)) {
          $response = Response::json(array('code' => 200, 'message' => 'Folder deleted successfully.', 'cause' => '', 'data' => array('image_list' => $image_list)));
        } else {
          $response = Response::json(array('code' => 200, 'message' => 'Folder deleted successfully.', 'cause' => '', 'data' => json_decode('{}')));
        }
      }
      ...
      if ($design_ids != '') {
        ...
        $response = Response::json(array('code' => 200, 'message' => 'Design deleted successfully.', 'cause' => '', 'data' => json_decode('{}')));
      }
...
//      Log::error("removeMyDesignFolder : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
  ...
  public function moveMyDesignInToFolder(Request $request_body)
  {
    try {
      ...
      $request = json_decode($request_body->getContent());
      if (($response = (new VerificationController())->validateRequiredParameter(array('my_design_ids'), $request)) != '')
        return $response;
      ...
      if (isset($my_design_id) && isset($des_folder_id) && isset($source_folder_id)) {
        ...
        if (count($already_exist) > 0) {
          return Response::json(array('code' => 201, 'message' => 'Any ' . count($already_exist) . ' design from the design list you provided already exists in this folder.', 'cause' => '', 'data' => json_decode('{}')));
        }
        ...
        $response = Response::json(array('code' => 200, 'message' => 'Design moved successfully.', 'cause' => '', 'data' => json_decode('{}')));

      } else if (isset($my_design_id) && isset($des_folder_id)) {
        ...
        $response = Response::json(array('code' => 200, 'message' => 'The design has been moved to folder.', 'cause' => '', 'data' => json_decode('{}')));

      } else if (isset($my_design_id) && isset($source_folder_id)) {
        ...
        $response = Response::json(array('code' => 200, 'message' => 'Design moved successfully.', 'cause' => '', 'data' => array('image_list' => $image_list)));
      }
...
//      Log::error("moveMyDesignInToFolder : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'moved design to the folder.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
  ...
  public function copyMyDesignsById(Request $request_body)
  {
    try {
      ...
      $request = json_decode($request_body->getContent());
      if (($response = (new VerificationController())->validateRequiredParameter(array('my_design_id','content_type'), $request)) != '')
        return $response;
      ...
      $copied_design_detail = array('image_result' => [
        'content_type'=> $content_type,
        'download_json' => $download_json,
      ...
      $this->deleteAllRedisKeys("getRecentMyDesign:$user_id");
      $response = Response::json(array('code' => 200, 'message' => 'Design copied successfully.', 'cause' => '', 'data' => $copied_design_detail));
    } catch (Exception $e) {
...
//      Log::error("getMyDesignFolder : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
  ...
  public function getMyVideoDesignFolder(Request $request_body)
  {
    try {
      ...
      $response = Response::json(array('code' => 200, 'message' => 'video design fetched successfully.', 'cause' => '', 'data' => $redis_result));
      $response->headers->set('Cache-Control', Config::get('constant.RESPONSE_HEADER_CACHE'));
...
//      Log::error("getMyIntroDesignFolder : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
  ...
  public function getMyDesignByFolderId(Request $request_body)
  {
    try {
      ...
      $this->user_id = $user_detail->id;
      $request = json_decode($request_body->getContent());
      if (($response = (new VerificationController())->validateRequiredParameter(array('page', 'item_count', 'folder_id'), $request)) != '')
        return $response;
...
//      Log::error("getMyDesignByFolderId : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
  ...
  public function getFolders(Request $request_body)
  {
    try {
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Folders fetched successfully.', 'cause' => '', 'data' => $redis_result));
      $response->headers->set('Cache-Control', Config::get('constant.RESPONSE_HEADER_CACHE'));

    } catch (Exception $e) {
      (new ImageController())->logs("getMyDesignByFolderId",$e);
//      Log::error("getMyDesignByFolderId : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'get folders.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
  ...
  public function saveMyDesign(Request $request_body)
  {
    try {
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Design saved successfully.', 'cause' => '', 'data' => $result));
  ...
  public function checkLimitExceededToSaveMyDesign(Request $request_body)
  {
    try {
      ...
      if (($response = (new VerificationController())->validateUserToCreateDesign($user_id,$content_type)) != '') {
        ...
        $result_array = array('is_limit_exceeded' => 1);
        $message = $data['original']['message'];
      } else {
        $result_array = array('is_limit_exceeded' => 0);
        $message = "";
      }

      $result = json_decode(json_encode($result_array), true);
      $response = Response::json(array('code' => 200, 'message' => $message, 'cause' => '', 'data' => $result));
...
//      Log::error("checkLimitExceededToSaveMyDesign : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'check limit exceeded or not.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
  ...
  public function updateMyDesign(Request $request_body)
  {
    try {
      ...
      $request = json_decode($request_body->input('request_data'));
      if (($response = (new VerificationController())->validateRequiredParameter(array('json_data', 'my_design_id', 'sub_category_id', 'sample_image', 'user_template_name'), $request)) != '')
        return $response;

      $response = (new VerificationController())->validateRequiredArrayParameter(array('deleted_object_images', 'deleted_transparent_images'), $request);
      if ($response != '') {
        return $response;
      }
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Design saved successfully.', 'cause' => '', 'data' => json_decode("{}")));

    } catch (Exception $e) {
      (new ImageController())->logs("updateMyDesign",$e);
//      Log::error("updateMyDesign : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'update design.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
    ...
    try {
      ...
      if (!Cache::has("Config::get('constant.REDIS_KEY'):getMyDesigns$this->user_id:$this->page:$this->item_count")) {
        $result = Cache::rememberforever("getMyDesigns$this->user_id:$this->page:$this->item_count", function () {
          ...
          $is_next_page = ($total_row > ($this->offset + $this->item_count)) ? true : false;
          return array('total_record' => $total_row, 'is_next_page' => $is_next_page, 'result' => $image_list, 'recommended_templates' => $recommended_templates);
...
//      Log::error("getMyDesigns : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'get designs.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
    ...
    */
    public function getContentDetailOfMyDesignById(Request $request_body)
    {
        try {
            ...
            if (!$redis_result) {
                $response = Response::json(array('code' => 201, 'message' => 'Requested design not found, Please try another template.', 'cause' => '', 'data' => $redis_result));
            }else{
...
//      Log::error("deleteMyDesignsById : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'delete my designs.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
...
//     }
  ...
  public function renameMyDesignNameById(Request $request_body)
  {
    try {
      ...
      $request = json_decode($request_body->getContent());
      if (($response = (new VerificationController())->validateRequiredParameter(array('my_design_id', 'user_template_name'), $request)) != '')
        return $response;
      ...
      $this->deleteAllRedisKeys("getRecentMyDesign:$user_id");
      $response = Response::json(array('code' => 200, 'message' => 'Design name updated successfully.', 'cause' => '', 'data' => json_decode('{}')));
    } catch (Exception $e) {
      (new ImageController())->logs("renameMyDesignNameById",$e);
//      Log::error("renameMyDesignNameById : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'update design name.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
...
//          return $response;
        ...
        if ($content_type == Config::get('constant.VIDEO')) {
          if (($response = (new VerificationController())->validateRequiredParameter(array('video_name', 'download_json'), $request)) != '')
            return $response;
          ...
          if (!$request_body->hasFile('overlay_image')) {
            return Response::json(array('code' => 201, 'message' => 'Required field overlay_image file is missing or empty.', 'cause' => '', 'data' => json_decode("{}")));
          } else {
...
//              return $response;
        ...
        if ($content_type == Config::get('constant.INTRO_VIDEO')) {
          ...
          if (($response = (new VerificationController())->validateRequiredParameter(array('download_json'), $request)) != '')
            return $response;
...
//      Log::error("saveMyTemplate : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
    ...
    public function saveTemplateWithLimitCheck(Request $request_body)
    {
        try {
            ...
            $image_list = array(array('my_design_id' => $uuid, 'folder_id' => $folder_id, 'user_id' => $user_uuid, 'sub_category_id' => $sub_category_uuid, 'sample_image' => Config::get('constant.MY_DESIGN_IMAGES_DIRECTORY_OF_DIGITAL_OCEAN').$card_image, 'overlay_image' => Config::get('constant.MY_DESIGN_IMAGES_DIRECTORY_OF_DIGITAL_OCEAN').$overlay_image));
            $result_array = array('result' => $image_list, 'is_limit_exceeded' => 0);
            $result = json_decode(json_encode($result_array), true);
            ...
            if($error_msg && $error_code){
                $response = Response::json(array('code' => $error_code, 'message' => $error_msg, 'cause' => '', 'data' => $result));
            }else{
                $response = Response::json(array('code' => 200, 'message' => isset($move_status_msg) ? $move_status_msg : 'Design saved successfully.', 'cause' => '', 'data' => $result));
            }
  ...
  public function updateTemplate(Request $request_body)
  {
    try {
      ...
      $result_array = array('my_design_id' => $my_design_id, 'folder_id' => $des_folder_id, 'template_img_name' => $card_image,'overlay_image' =>$overlay_image_url);
      $response = Response::json(array('code' => 200, 'message' => isset($move_status_msg) ? $move_status_msg : 'Design saved successfully.', 'cause' => '', 'data' => $result_array));
...
//      Log::error("updateTemplate : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
  ...
  public function updateIntrosTemplate(Request $request_body)
  {
    try {
      ...
      $result_array = array('my_design_id' => $my_design_id, 'template_img_name' => $card_image,'overlay_image' =>$overlay_image_url);
      $response = Response::json(array('code' => 200, 'message' => 'Design saved successfully.', 'cause' => '', 'data' => $result_array));
  ...
  */
  ...
  public function saveMyTemplateV2(Request $request_body)
  {
    try {
        ...
        $image_list = array(array('my_design_id'=>$uuid, 'user_id'=>$user_uuid, 'sub_category_id'=>$sub_category_uuid, 'sample_image'=>Config::get('constant.MY_DESIGN_IMAGES_DIRECTORY_OF_DIGITAL_OCEAN').$card_image));
    ...
    public function saveMultiPageTemplateWithLimitCheck(Request $request_body)
    {
        try {
            ...
            $image_list = array(array('my_design_id' => $uuid, 'folder_id' => $folder_id, 'user_id' => $user_uuid, 'sub_category_id' => $sub_category_uuid, 'sample_image' => Config::get('constant.MY_DESIGN_IMAGES_DIRECTORY_OF_DIGITAL_OCEAN') . $card_image));
            $result_array = array('result' => $image_list, 'is_limit_exceeded' => 0);
            $result = json_decode(json_encode($result_array), true);
  ...
  */
  ...
  public function updateTemplateV2(Request $request_body)
  {
    try {
        ...
        $result_array = array('my_design_id' => $my_design_id, 'folder_id' => $des_folder_id, 'template_img_name' => $card_image);
        $response = Response::json(array('code' => 200, 'message' => isset($move_status_msg) ? $move_status_msg : 'Design saved successfully.', 'cause' => '', 'data' => $result_array));
    ...
    try {
      ...
      if($country != NULL){
        if (($country_code = (new UserVerificationController())->getCountryCode($country)) == '') {
          return Response::json(array('code' => 201, 'message' => 'Unable to set billing address.', 'cause' => '', 'data' => json_decode('{}')));
        }
//        Log::info('$country_code :',[$country_code]);
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Billing address saved successfully.', 'cause' => '', 'data' => json_decode('{}')));
    } catch (Exception $e) {
      (new ImageController())->logs("setBillingAddress",$e);
//      Log::error("setBillingAddress : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'set billing address.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
  ...
  public function getBillingInfo()
  {
    ...
    try {
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Billing Information fetched successfully.', 'cause' => '', 'data' => $redis_result));
      $response->headers->set('Cache-Control', Config::get('constant.RESPONSE_HEADER_CACHE'));

    } catch (Exception $e) {
      (new ImageController())->logs("getBillingInfo",$e);
//      Log::error("getBillingInfo : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'get billing information.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
  ...
  public function giveFeedback(Request $request_body)
  {
    try {
      ...
      $request = json_decode($request_body->getContent());
      if (($response = (new VerificationController())->validateRequiredParameter(array('rate','feedback_url'), $request)) != '')
        return $response;
      ...
      if (($feedback_text == NULL or $feedback_text == "") and ($rate == 0 or $rate == NULL)) {
        return $response = Response::json(array('code' => 201, 'message' => 'Required field(s) feedback_text and rate both are missing or empty.', 'cause' => '', 'data' => json_decode('{}')));
      }
      $uuid = (new ImageController())->generateUUID();
      DB::beginTransaction();
...
//      Log::error("giveFeedback : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'give feedback.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
...
//      Log::error("updateFeedback : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'update feedback.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
  ...
  public function getFeedback()
  {
    ...
    try {
      ...
      if (!$redis_result) {
        ...
        $response = Response::json(array('code' => 200, 'message' => 'Feedback fetched successfully.', 'cause' => '', 'data' => $redis_result[0]));
      }
...
//      Log::error("getFeedback : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'get feedback.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
  ...
  public function submitReport(Request $request_body)
  {
    try {
      ...
      if (($report_text == NULL or $report_text == "") and (!$request_body->hasFile('file'))) {
        return $response = Response::json(array('code' => 201, 'message' => 'Required field(s) report_text and file both are missing or empty.', 'cause' => '', 'data' => json_decode('{}')));
      }
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Report submitted successfully.', 'cause' => '', 'data' => json_decode('{}')));
    } catch (Exception $e) {
      (new ImageController())->logs("submitReport",$e);
//      Log::error("submitReport : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'submit report.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
  ...
  public function getDashboardData(Request $request)
  {
    ...
    try {
        ...
        $result = Cache::rememberforever("getDashboardData$this->item_count:$this->sub_category_ids", function () {
          ...
          foreach ($this->sub_category_id_list as $key) {
            ...
            if (count($sub_category) > 0) {
              ...
              $result_array[] = array('sub_category_id' => $sub_category_id, 'sub_category_name' => $sub_category_name, 'sample_cards' => $sample_cards);
            }
      ...
      $response = Response::json(array('code' => 200, 'message' => 'All sample cards & categories are fetched successfully.', 'cause' => '', 'data' => $redis_result));
      $response->headers->set('Cache-Control', Config::get('constant.RESPONSE_HEADER_CACHE'));
...
//      Log::error("getDashboardData : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'get sample cards and sub categories.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
  ...
  public function getDashBoardDetails()
  {
    try {
      ...
      $response = Response::json(array('code' => 200, 'message' => 'All tags fetched successfully.', 'cause' => '', 'data' => ['tag_details' => $tag_details, 'payment_status_details' => $payment_status_details]));
      $response->headers->set('Cache-Control', Config::get('constant.RESPONSE_HEADER_CACHE'));

    } catch (Exception $e) {
      (new ImageController())->logs("getDashBoardDetails", $e);
      //Log::error("getDashBoardDetails : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . ' get dashboard details.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
...
//      Log::error("getFeaturedCatalogsBySubCategoryId : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . ' get featured catalogs.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
    ...
    public function getContentDetailById(Request $request_body)
    {
        try {
            ...
            if($this->user_detail->roles){
                ...
                return Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'get content detail.', 'cause' => '', 'data' => json_decode("{}")));
            }
            ...
            $redis_result = Cache::rememberforever("getContentDetailById:$this->content_id:$this->content_type:$this->page_id", function () {
                ...
                if (count($result) > 0 && $result[0]->json_data) {
                    ...
                    if($this->page_id){
                        ...
                        $result[0]->pages_sequence = array($this->page_id);
                    }
            ...
            if (!$redis_result) {
            ...
            }else if($this->content_type != Config::get('constant.CONTENT_TYPE_OF_3D_TEXT_JSON') && $this->content_type != Config::get('constant.CONTENT_TYPE_OF_3D_SHAPE') && $redis_result->is_free == 0 && $this->user_role == Config::get('constant.ROLE_FOR_USER')){
                ...
                return Response::json(array('code' => 432, 'message' => 'Free users are not authorized to create pro designs.', 'cause' => '', 'data' => json_decode("{}")));
            }
  ...
  */
  ...
  public function getSampleContentBySubCategoryId(Request $request_body)
  {
    try {
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Sample content fetched successfully.', 'cause' => '', 'data' => ['result' => $redis_result]));
      $response->headers->set('Cache-Control', Config::get('constant.RESPONSE_HEADER_CACHE'));
...
//      Log::error("getSampleContentBySubCategoryId : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . ' get sample content.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
...
//      Log::error("getStickerCatalogsBySubCategoryId : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'get normal catalogs.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
  ...
  public function searchTemplateBySubCategoryIdBackUp(Request $request_body)
  {
    try {
      ...
      $request = json_decode($request_body->getContent());
      if (($response = (new VerificationController())->validateRequiredParameter(array('sub_category_id', 'page','content_type'), $request)) != '')
        return $response;
          ...
          $result = Cache::remember("searchTemplateFromAllCategory$this->sub_category_id:$this->search_category:$this->content_type_for_cache:$this->page:$this->item_count", $this->time_of_expired_redis_key, function () {
            ...
            if (!Cache::has("Config::get('constant.REDIS_KEY'):defaultFeaturedTemplates$this->default_sub_category_id:$this->content_type_for_cache")) {
              $result = Cache::remember("defaultFeaturedTemplates$this->default_sub_category_id:$this->content_type_for_cache", $this->time_of_expired_redis_key, function () {
                ...
                $result = array('total_row' => $total_row, 'search_result' => $search_result);
                return $result;
            ...
            $result = array('code' => $code, 'message' => $message, 'result' => $search_result);
...
//      dd($this->select_column, $this->table_condition, $this->default_table_condition, $this->where_condition, $this->default_where_condition, $this->order_by_clause, $this->default_order_by_clause);
      ...
      $redis_result = Cache::remember(Config::get('constant.REDIS_PREFIX') . "searchTemplateBySubCategoryId:$this->sub_category_id:$this->search_category:$this->content_type_for_cache:$this->page:$this->item_count", Config::get('constant.CACHE_TIME_6_HOUR'), function () {
        ...
        if ($total_row) {
          ...
          return array('code' => $this->success_code, 'message' => $this->success_message, 'result' => $search_result);

        } else {

          $is_next_page = ($total_row > ($this->offset + $this->item_count)) ? true : false;
          $search_result = array('total_record' => $total_row, 'is_next_page' => $is_next_page, 'result' => []);

          return array('code' => $this->default_code, 'message' => $this->default_message, 'result' => $search_result);
        }
      ...
      if (!$redis_result) {
        $redis_result = [];
        $response = Response::json(array('code' => $this->default_code, 'message' => $this->default_message, 'cause' => '', 'data' => json_decode("{}")));
      }else{
        if($this->search_category != ''){
          if($this->page == 1){
            if($redis_result['code'] == 200){
...
//      dd($this->select_column, $this->table_condition, $this->default_table_condition, $this->where_condition, $this->default_where_condition, $this->order_by_clause, $this->default_order_by_clause);
  ...
  public function getSuggestionTextsForTemplate(Request $request)
  {
    try {
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Suggestion texts fetched successfully.', 'cause' => '', 'data' => ['total_record' => count($redis_result), 'result' => $redis_result]));
      $response->headers->set('Cache-Control', Config::get('constant.RESPONSE_HEADER_CACHE'));

    } catch (Exception $e) {
      (new ImageController())->logs("getSuggestionTextsForTemplate",$e);
//      Log::error("getSuggestionTextsForTemplate : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'get suggestion texts.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
    ...
    try {
      ...
      if($is_cache_enable){
        $redis_result = Cache::remember(Config::get('constant.REDIS_PREFIX') . "getTemplateByCatalogId:$this->page:$this->item_count:$this->catalog_id:$this->sub_category_id", Config::get('constant.CACHE_TIME_6_HOUR'), function () {
          ...
          $is_next_page = ($total_row > ($this->offset + $this->item_count)) ? true : false;
          return array('total_record' => $total_row, 'is_next_page' => $is_next_page, 'content_list' => $result);
        });
          ...
          $is_next_page = ($total_row > ($this->offset + $this->item_count)) ? true : false;
          $redis_result = array('total_record' => $total_row, 'is_next_page' => $is_next_page, 'content_list' => $result);
...
//      Log::error("getTemplateByCatalogId : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
    ...
    public function getTemplatesByCatalogIdForDesignPage(Request $request_body)
    {
        try {
            ...
            if($this->sub_category_id != $this->brandkit_sub_category_id){
                ...
                return Response::json(array('code' => 201, 'message' => 'Unable to match sub category.', 'cause' => '', 'data' => json_decode("{}")));
            }
    ...
    public function getTemplateByCatalogNameAsTag(Request $request_body)
    {
        try {
            ...
            $request = json_decode($request_body->getContent());
            if (($response = (new VerificationController())->validateRequiredParameter(array('sub_category_id', 'catalog_id', 'catalog_name', 'height', 'width', 'page', 'item_count'), $request)) != '')
                return $response;
          ...
          if ($is_cache_enable) {
            ...
            $is_next_page = ($total_row > ($this->offset + $this->item_count)) ? true : false;
            $redis_result = array('total_record' => $total_row, 'is_next_page' => $is_next_page, 'result' => $search_result);
          }
            $response = Response::json(array('code' => 200, 'message' => 'All templates are fetched successfully.', 'cause' => '', 'data' => $redis_result));
            $response->headers->set('Cache-Control', Config::get('constant.RESPONSE_HEADER_CACHE'));
  ...
  public function searchSticker(Request $request_body)
  {
    try {
      ...
      $request = json_decode($request_body->getContent());
      if (($response = (new VerificationController())->validateRequiredParameter(array('page', 'item_count', 'search_query'), $request)) != '')
        return $response;
...
//                                                    ORDER BY search_text DESC,cm.update_time DESC LIMIT ?, ?', [Config::get('constant.CONTENT_TYPE_OF_IMAGE'), Config::get('constant.CONTENT_TYPE_OF_SVG'), $this->offset, $this->item_count]);
          ...
          $is_next_page = ($total_row > ($this->offset + $this->item_count)) ? true : false;
          return array('total_record' => $total_row, 'is_next_page' => $is_next_page, 'content_list' => $stickers, 'sub_category_ids' => $sub_category_list[0]->sub_category_ids);
...
//      Log::error("searchSticker : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'search sticker.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
    ...
    try {
      ...
      $redis_result = Cache::rememberforever("searchBackground$this->search_query:$this->page:$this->item_count", function () {
        ...
        if (count($catalog_list) > 0) {
          ...
          $is_next_page = ($total_row > ($this->offset + $this->item_count)) ? true : false;
          return array('total_record' => $total_row, 'is_next_page' => $is_next_page, 'content_list' => $stickers, 'catalog_ids' => $catalog_list[0]->catalog_ids, 'sub_category_ids' => $catalog_list[0]->sub_category_ids);
...
//      Log::error("searchBackground : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'search background.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
  ...
  public function searchStickerMCM(Request $request_body)
  {
    try {
      ...
      $response = Response::json(array('code' => 201, 'message' => config('constant.EXCEPTION_ERROR') . 'search sticker.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
  ...
  public function searchBackgroundMCM(Request $request_body)
  {
    try {
      ...
      $response = Response::json(array('code' => 201, 'message' => config('constant.EXCEPTION_ERROR') . 'search background.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
    ...
    public function searchTextArt(Request $request_body)
  {
    try {
      ...
      $request = json_decode($request_body->getContent());
      if (($response = (new VerificationController())->validateRequiredParameter(array('sub_category_id', 'page', 'item_count', 'search_query'), $request)) != '')
        return $response;
      ...
      $redis_result = Cache::rememberforever("searchTextArt:$this->sub_category_id:$this->search_query:$this->page:$this->item_count", function () {
        ...
        $is_next_page = ($total_row > ($this->offset + $this->item_count)) ? true : false;
        return array('total_record' => $total_row, 'is_next_page' => $is_next_page, 'content_list' => $stickers);
...
//      Log::error("searchTextArt : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'search textart.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
  ...
  public function searchAudioOrVideo(Request $request_body)
  {
    try {
      ...
      $request = json_decode($request_body->getContent());
      if (($response = (new VerificationController())->validateRequiredParameter(array('page', 'item_count', 'search_query', 'content_type'), $request)) != '')
        return $response;
      ...
      if ($content_type == Config::get('constant.CONTENT_TYPE_OF_VIDEO')) {
        ...
        $redis_result = Cache::rememberforever("searchAudioOrVideo:$this->search_query:$this->page:$this->item_count:$this->content_type", function () {
          ...
          $videos = DB::select('SELECT
            ...
            [
              ...
              $this->item_count]);
          $is_next_page = ($total_row > ($this->offset + $this->item_count)) ? true : false;
          return array('total_record' => $total_row, 'is_next_page' => $is_next_page, 'content_list' => $videos, 'sub_category_id' => $sub_category_id);
        ...
        $redis_result = Cache::rememberforever("searchAudioOrVideo:$this->search_query:$this->page:$this->item_count:$this->content_type", function () {
          ...
          $is_next_page = ($total_row > ($this->offset + $this->item_count)) ? true : false;
          return array('total_record' => $total_row, 'is_next_page' => $is_next_page, 'content_list' => $audio, 'sub_category_id' => $sub_category_id);
        });
...
//      Log::error("searchAudioOrVideo : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'search audio/video.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
...
//      Log::error("getNormalCatalogsBySubCategoryId : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
  ...
  public function setPaymentStatus(Request $request)
  {
    try {
      ...
      if (($response = (new VerificationController())->validateRequiredParameter(array('txn_id', 'paypal_response', 'paypal_payment_status'), $request)) != '')
        return $response;
...
//      Log::error("setPaymentStatus : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'set payment status.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
    ...
    try {
      ...
      if ($request_body->hasFile('file')) {
        ...
        if (strstr($file_name, '.webp')) {
          ...
          $response = Response::json(array('code' => 200, 'message' => '3D shape updated successfully.', 'cause' => '', 'data' => json_decode('{}')));


        } else {
          $response = Response::json(array('code' => 200, 'message' => '3D shape updated successfully. Note: webp is not converted due to size grater than original.', 'cause' => '', 'data' => json_decode('{}')));
...
//      Log::error("edit3DShape : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'edit 3D shape.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
  ...
  public function deleteMyAccount()
  {
    ...
    try {
      ...
      if ($user_id != 1) {
        ...
        $response = Response::json(array('code' => 200, 'message' => 'Account deleted successfully.', 'cause' => '', 'data' => json_decode('{}')));
...
//      Log::error("deleteMyAccount : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'delete account.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
  ...
  public function generateSVGWithXML(Request $request_body)
  {
    try {
      ...
      if (!$request_body->hasFile('file')) {
        ...
        $result_array = array('result' => $exist_files_array);

        $result = json_decode(json_encode($result_array), true);
        $response = Response::json(array('code' => 200, 'message' => 'SVG generated successfully.', 'cause' => '', 'data' => $result));
...
//      Log::error("generateSVGWithXML : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'generate svg.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
    ...
    public function getShareLinkContentForUser(Request $request_body)
    {
      try {
        ...
        if($this->is_enable[0]->is_enable == 0){
          $result =  array('is_enable' => $this->is_enable[0]->is_enable ,'result' => array());
        } else{
          ...
          if (!Cache::has("Config::get('constant.REDIS_KEY'):getShareLinkContentForUser$this->user_id")) {
            $result = Cache::remember("getShareLinkContentForUser$this->user_id", 5,function () {
              ...
              return array('is_enable' => $this->is_enable[0]->is_enable ,'result' => $media_list);
            });
          }
        ...
        $response = Response::json(array('code' => 200, 'message' => 'Detail fetched successfully.', 'cause' => '', 'data' => $result));
      } catch (Exception $e) {
        (new ImageController())->logs("getShareLinkContentForUser",$e);
//        Log::error("getShareLinkContentForUser : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
        $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'get details.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      }
        return $response;
    }
   ...
   */
    public function addSharedLinkDetailsByUser(Request $request_body){
      try {
        ...
        $request = json_decode($request_body->getContent());
        if (($response = (new VerificationController())->validateRequiredParameter(array('link_id', 'social_id'), $request)) != '')
          return $response;
        ...
        if(count(DB::select('SELECT 1 FROM user_shared_link_master WHERE link_id = ? AND user_id = ? AND social_id = ? AND now() < share_it_after',[$link_id,$user_id,$social_id])) > 0){
          return $response = Response::json(array('code' => 201, 'message' => 'Sorry, you are not eligible to share at this time.', 'cause' => '', 'data' => ''));
        }
...
//        $share_it_after = date('Y-m-d H:i:s' ,strtotime($last_shared_at. '+ '. $frequency[0]->frequency. ' day'));
        ...
        $response = Response::json(array('code' => 200, 'message' => 'User shared link details added successfully.', 'cause' => '', 'data' => ''));
      } catch (Exception $e) {
        (new ImageController())->logs("addSharedLinkDetailsByUser",$e);
//        Log::error("addSharedLinkDetailsByUser : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
        $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'add details.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
  ...
  public function uploadChunkFile($request_body)
  {
    try {
      ...
      if ($chunks == count($files)) {
        ...
        return array('code' => 200, 'message' => 'Image uploaded successfully.', 'cause' => '', 'data' => $result);
      } else {
        return array('code' => 200, 'message' => 'File in progress.', 'cause' => '', 'data' => (count($files) * 100) / $chunks);
      }

    } catch (Exception $e) {
      Log::error("uploadChunkFile : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      return array('code' => 201, 'message' => config('constant.EXCEPTION_ERROR') . 'upload image.', 'cause' => $e->getMessage(), 'data' => json_decode("{}"));
    }
  }
...
//          $default_sub_category_id = Config::get('constant.DEFAULT_SUB_CATEGORY_ID_TO_GET_RECOMMENDED_TEMPLATES');
      ...
      return array('total_record' => $total_row, 'is_next_page' => $is_next_page, 'folder_result' => $folder_list, 'image_result' => $image_list);
...
//      Log::error("add3DObjectImages : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'add 3D object images.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
...
//      Log::error("addTransparentImages : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'add transparent images.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
...
//      Log::error("addStockPhotos : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'add stock photos.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
    ...
    public function add3DObjectImagesV2($image_array, $image, $my_design_id, $create_time, $deleted_file_list)
    {
        try {
            ...
            $response = array('code' => 200, 'message' => 'object image saved successfully.', 'cause' => '', 'data' => $deleted_file_list);
            ...
            $response = array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'add 3D object images.', 'cause' => $e->getMessage(), 'data' => $deleted_file_list);
            DB::rollBack();
        }
        return $response;
    }
    ...
    public function addTransparentImagesV2($image_array, $image, $my_design_id, $create_time, $deleted_file_list)
    {
        try {
            ...
            $response = array('code' => 200, 'message' => 'transparent image saved successfully.', 'cause' => '', 'data' => $deleted_file_list);
            ...
            $response = array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'add transparent images.', 'cause' => $e->getMessage(), 'data' => $deleted_file_list);
            DB::rollBack();
        }
        return $response;
    }
    ...
    public function addStockPhotosV2($images_array, $my_design_id, $create_time, $deleted_file_list)
    {
        try {
            ...
            $response = array('code' => 200, 'message' => 'stock image saved successfully.', 'cause' => '', 'data' => $deleted_file_list);

        } catch (Exception $e) {
            Log::error("addStockPhotosV2 : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'add stock photos.', 'cause' => $e->getMessage(), 'data' => $deleted_file_list);
            DB::rollBack();
        }
        return $response;
    }
...
//      Log::error("increaseMyDesignCount : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'increase my design count.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
...
//      Log::error("removeMyDesignIdFromTheList : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'delete stock photos.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
...
//      Log::error("removeMyDesignIdFromThe3dImageList : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'delete 3D photos.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
...
//      Log::error("removeMyDesignIdFromTheTransparentImageList : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'delete transparent photos.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
...
//      Log::error("edit3DObjectImages : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'edit 3D object images.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
...
//      Log::error("editTransparentImages : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'edit transparent images.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
...
//      Log::error("deleteMyDesignImage : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'delete my design image.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
...
//        Log::error("deleteProfile : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
        $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'delete profile.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
        DB::rollBack();
      }
      return $response;
    }
...
//        Log::error("getExpiry : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
        $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'get expiry.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      }
      return $response;
    }
  ...
  public function generateVideo(Request $request_body)
  {
    try {
      ...
      if ($user_detail->roles) {
        ...
        return Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'generate video.', 'cause' => '', 'data' => json_decode("{}")));
      }
      ...
      if (!$request_body->hasFile('transparent_img')) {
        ...
        return Response::json(array('code' => 201, 'message' => 'Required field transparent_img is missing or empty', 'cause' => '', 'data' => json_decode("{}")));
      }

      if (($response = (new VerificationController())->validateRequiredParameter(array('video_name', 'is_video_user_uploaded', 'out_width', 'out_height', 'is_trim', 'quality'), $request)) != '') {
      ...
      if ($request->quality == Config::get('constant.FULL_HD_VIDEO') && $role_id == Config::get('constant.ROLE_ID_FOR_FREE_USER')) {
        ...
        return Response::json(array('code' => 432, 'message' => 'Free users are not authorized to download design of Pro qualities.', 'cause' => '', 'data' => json_decode("{}")));
      }

      if ($request->is_trim) {
        if (($response = (new VerificationController())->validateRequiredParameter(array('start_time', 'end_time', 'trim_duration'), $request)) != '') {
      ...
      if (isset($request->audio_name)) {
        if (($response = (new VerificationController())->validateRequiredParameter(array('is_audio_user_uploaded', 'audio_start_time', 'audio_end_time', 'audio_duration', 'is_audio_trim'), $request)) != '') {
      ...
      if ($result['result_status'] == 0) {
        ...
        $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'generate video.', 'cause' => '', 'data' => json_decode("{}")));
      } else {
        $response = Response::json(array('code' => 200, 'message' => 'Video generated successfully', 'cause' => '', 'data' => ['download_id' => $result['download_id']]));
      }
  ...
  public function uploadVideo(Request $request_body)
  {
    try {
      ...
      if (is_object($response['data'])) {
        ...
        $response = Response::json(array('code' => 200, 'message' => 'Video uploaded successfully.', 'cause' => '', 'data' => json_decode('{}')));
      }

    } catch (Exception $e) {
      (new ImageController())->logs("uploadVideoByUser", $e);
      //Log::error("uploadVideoByUser : ", ['Exception' => $e->getMessage(), '\nTraceAsString' => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'user upload video.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
...
//          (new ImageController())->saveUserUploadedWebpImageInToS3($thum_video_file_name);
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Video uploaded successfully.', 'cause' => '', 'data' => ['result' => $image_detail]));
    } catch (Exception $e) {
      (new ImageController())->logs("uploadVideoByUser",$e);
//      Log::error("uploadVideoByUser : ", ['Exception' => $e->getMessage(), '\nTraceAsString' => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'user upload video.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    ...
    try {
      ...
      if (!Cache::has("Config::get('constant.REDIS_KEY'):getMyUploadedVideos:$this->page:$this->item_count:$this->user_id")) {
        $result = Cache::rememberforever("getMyUploadedVideos:$this->page:$this->item_count:$this->user_id", function () {
          ...
          $is_next_page = ($total_row > ($this->offset + $this->item_count)) ? true : false;
          return array('total_record' => $total_row, 'is_next_page' => $is_next_page, 'result' => $image_list);
        });
      }
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Videos fetched successfully.', 'cause' => '', 'data' => $redis_result));
      $response->headers->set('Cache-Control', Config::get('constant.RESPONSE_HEADER_CACHE'));

    } catch (Exception $e) {
      (new ImageController())->logs("getMyUploadedVideos",$e);
//      Log::error("getMyUploadedVideos : ", ['Exception' => $e->getMessage(), '\nTraceAsString' => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'get my uploaded videos.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
  ...
  public function deleteMyUploadedVideoById(Request $request_body)
  {
    try {
      ...
      $request = json_decode($request_body->getContent());
      if (($response = (new VerificationController())->validateRequiredParameter(array('user_uploaded_video_id'), $request)) != '')
        return $response;
      ...
      if (count($delete_detail) <= 0) {
        return Response::json(array('code' => 201, 'message' => 'Video does not exist.', 'cause' => '', 'data' => json_decode('{}')));
      }
...
//      Log::error("deleteMyUploadedVideoById : ", ['Exception' => $e->getMessage(), '\nTraceAsString' => $e->getTraceAsString()]);
  ...
  public function uploadAudio(Request $request_body)
  {
    try {
      ...
      if (is_object($response['data'])) {
        ...
        $response = Response::json(array('code' => 200, 'message' => 'Audio uploaded successfully.', 'cause' => '', 'data' => json_decode('{}')));
      ...
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'upload audio by audio.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
  ...
  public function uploadAudioByUser(Request $request_body)
  {
    try {
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Audio uploaded successfully.', 'cause' => '', 'data' => ['result' => $image_detail]));
    } catch (Exception $e) {
...
//      Log::error("uploadAudioByUser : ", ['Exception' => $e->getMessage(), '\nTraceAsString' => $e->getTraceAsString()]);
  ...
  public function getMyUploadedAudio(Request $request_body)
  {
    ...
    try {
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Audios fetched successfully.', 'cause' => '', 'data' => $redis_result));
      $response->headers->set('Cache-Control', Config::get('constant.RESPONSE_HEADER_CACHE'));

    } catch (Exception $e) {
      (new ImageController())->logs("getMyUploadedAudio",$e);
//      Log::error("getMyUploadedAudio : ", ['Exception' => $e->getMessage(), '\nTraceAsString' => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'get my uploaded audio.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
  ...
  public function deleteMyUploadedAudioById(Request $request_body)
  {
    try {
      ...
      $request = json_decode($request_body->getContent());
      if (($response = (new VerificationController())->validateRequiredParameter(array('user_uploaded_audio_id'), $request)) != '')
        return $response;
      ...
      if(count($result) <= 0){
       return Response::json(array('code' => 201, 'message' => 'Audio does not exist.', 'cause' => '', 'data' => json_decode('{}')));
      }
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Audio deleted successfully.', 'cause' => '', 'data' => json_decode('{}')));
    } catch (Exception $e) {
      (new ImageController())->logs("deleteMyUploadedAudioById",$e);
//      Log::error("deleteMyUploadedAudioById : ", ['Exception' => $e->getMessage(), '\nTraceAsString' => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'delete audio.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
  ...
  public function searchFontByUser(Request $request_body)
  {
    try {
      ...
      $request = json_decode($request_body->getContent());
      if (($response = (new VerificationController())->validateRequiredParameter(array('search_query'), $request)) != '')
        return $response;
      ...
      if($this->search_query != '' && strlen($this->search_query) > 0) {
        if (!Cache::has("Config::get('constant.REDIS_KEY'):searchFontByUser:$this->search_query")) {
          ...
          return array('total_record' => $total_row, 'result' => $fonts_list);
        ...
        $response = Response::json(array('code' => 200, 'message' => 'Fonts search successfully.', 'cause' => '', 'data' => $redis_result));
      }else{
        $response = Response::json(array('code' => 201, 'message' => 'Sorry, we couldn\'t find any font for '.$request->search_query.'.', 'cause' => '', 'data' => json_decode("{}")));
      }
    } catch (Exception $e) {
      (new ImageController())->logs("searchFontByUser",$e);
//      Log::error("searchFontByUser : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . ' search font by user.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
  ...
  public function searchFontByUserV2(Request $request_body)
  {
    try {
      ...
      $response = Response::json(array('code' => 201, 'message' => config('constant.EXCEPTION_ERROR') . ' search font by user.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
...
//      Log::error("searchUploadedFontByUser : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . ' search uploaded font by user.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
  ...
  public function publishDesignByUser(Request $request_body)
  {
    try {
      ...
      $request = json_decode($request_body->getContent());
      if (($response = (new VerificationController())->validateRequiredParameter(array('design_id','sub_category_id'), $request)) != '')
        return $response;
...
//        }
        ...
        return Response::json(array('code' => 201, 'message' => 'Invalid design id.', 'cause' => '', 'data' => json_decode("{}")));
      }
      $response = Response::json(array('code' => 200, 'message' => 'Design add to publish,We will inform.', 'cause' => '', 'data' => json_decode("{}")));
    } catch (Exception $e) {
      (new ImageController())->logs("publishDesignByUser",$e);
//      Log::error("publishDesignByUser : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'publish design.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
  ...
  public function getEncryptIdForDesignTemplate(Request $request_body){
    try {
      ...
      $template_array =  isset($request->template_array) ? $request->template_array : array();
      if(count($template_array) <= 0){
       return Response::json(array('code' => 201, 'message' => 'Required field template_array is missing or empty.', 'cause' => '', 'data' => json_decode("{}")));
      }
      $content_id = array();
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Id fetch successfully.', 'cause' => '', 'data' => $template_array));

    } catch (Exception $e) {
      (new ImageController())->logs("getEncryptIdForDesignTemplate",$e);
//      Log::error("getEncryptIdForDesignTemplate : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . ' get encrypt id.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
  /**
  ...
  public function getEncryptId(Request $request_body){
    try {
      ...
      $data = array("sub_category_id"=>$sub_category_id,"catalog_id" => $catalog_id,"content_id"=>$content_id);

      $response = Response::json(array('code' => 200, 'message' => 'Id fetch successfully.', 'cause' => '', 'data' =>$data ));
...
//      Log::error("getEncryptIdForDesignTemplate : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
  ...
  public function encryptStaticPageCTALink(Request $request_body){
    ...
    foreach ($pages as $row) {
      ...
      $response = Response::json(array('code' => 200, 'message' => 'CTA link encrypted successfully.', 'cause' => '', 'data' =>json_decode("{}") ));

    } catch (Exception $e) {
      (new ImageController())->logs("encryptStaticPageCTALink",$e);
      DB::rollBack();
//      Log::error("encryptStaticPageCTALink : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . ' encrypt CTA link.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
    ...
    public function removeDesignerNameFromResource(Request $request_body)
    {
        try {
            ...
            $request = json_decode($request_body->getContent());
            if (($response = (new VerificationController())->validateRequiredArrayParameter(array('limit'), $request)) != '')
                return $response;
            ...
            $response = Response::json(array('code' => 200, 'message' => 'Designer name removed successfully.', 'cause' => '', 'data' => ['content_details_count' => count($content_details), 'total_word_counter' => $counter, 'counter' => $image_counter, 'all_url' => $all_url]));

        } catch (Exception $e) {
            Log::error("removeDesignerNameFromResource : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'remove designer name.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
        }
        return $response;
    }
...
//      Log::error("addCategoryASTag : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
  ...
  public function cancelAllStripeSubscription(Request $request_body)
  {
    try {
      ...
      $request = json_decode($request_body->getContent());
      if (($response = (new VerificationController())->validateRequiredParameter(array('item_count'), $request)) != '')
        return $response;
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Subscriptions cancel successfully.', 'cause' => '', 'data' =>array('total_record' => $total_row, 'is_next_page' => $is_next_page)));
    } catch (Exception $e) {
      (new ImageController())->logs("cancelAllStripeSubscription",$e);
//      Log::error("cancelAllStripeSubscription : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'cancel stripe subscription.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
    ...
    public function addIndexInImageJson(Request $request_body)
    {
        try {
            ...
            $request = json_decode($request_body->getContent());
            if (($response = (new VerificationController())->validateRequiredArrayParameter(array('sub_category_ids'), $request)) != '')
                return $response;
            ...
            $response = Response::json(array('code' => 200, 'message' => 'Index added successfully.', 'cause' => '', 'data' => $i));

        } catch (Exception $e) {
            Log::error("addIndexInImageJson : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'add index in json.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
        }
        return $response;
    }
    ...
    public function addIndexInImageJsonWhileCardUploading($single_page_json_data)
    {
        try {
            ...
            $response = Response::json(array('code' => 200, 'message' => 'Index added successfully.', 'cause' => '', 'data' => json_decode("{}")));
    ...
    public function addAnimatedStickerZip(Request $request_body)
    {
        try {
            ...
            if (!$request_body->hasFile('zip_file')) {
                return Response::json(array('code' => 201, 'message' => 'Required field zip_file is missing or empty.', 'cause' => '', 'data' => json_decode("{}")));
            }
            $request = json_decode($request_body->input('request_data'));
...
//                        }
            ...
            list($width, $height) = getimagesize($extracted_dir ."/1.png");
            ...
            if (!file_exists($output_file) && $result != 0) {
                ...
                return Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . ' generate original animated webp.', 'cause' =>"", 'data' => json_decode("{}")));
            }
            ...
            if (!file_exists($output_file) && $result != 0) {
                ...
                return Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . ' generate compressed animated webp.', 'cause' =>"", 'data' => json_decode("{}")));
            }

            $response = Response::json(array('code' => 200, 'message' => 'Animated sticker added successfully.', 'cause' => '', 'data' => json_decode('{}')));

        } catch (Exception $e) {
            Log::error("addAnimatedStickerZip : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'animated sticker.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
        }
        return $response;
    }
  ...
  public function analysisMail(Request $request_body){
    try {
      $request = json_decode($request_body->getContent());
      if (($response = (new VerificationController())->validateRequiredParameter(array('email','template','subject'), $request)) != '')
        return $response;

      if (($response = (new VerificationController())->validateRequiredParameterIsArray(array('message_body'), $request)) != '')
        return $response;
      ...
      $data = array('data' => array("app_name" => $app_name, 'start_date' => $start_date, 'end_date' => $end_date, 'tags' => array()), 'template' => $template, 'email' => $email_id, 'subject' => $subject, 'message_body' => $message_body);
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Mail sent successfully.', 'cause' => '', 'data' => json_decode("{}")));
    }catch (Exception $e){
      Log::error("analysisMail : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'sent mail.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
  ...
  public function uploadFile(Request $request_body)
  {
    try {
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Image upload successfully.', 'cause' => '', 'data' => $file_path));
    } catch (Exception $e) {
  ...
  public function setUserSessionOnSignup(Request $request_body)
  {
    try {
      ...
      if (!config('constant.IS_USER_SESSION_ANALYTICS_ENABLE')) {
        return Response::json(array('code' => 200, 'message' => 'Information added successfully.', 'cause' => '', 'data' => json_decode("{}")));
      }
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Information added successfully.', 'cause' => '', 'data' => json_decode("{}")));
    } catch (Exception $e) {
  ...
  public function validateUserKeyword($user_keyword)
  {
    try {
      ...
      $specified_words = array('design','search','tools','calendar','create','features');
      ...
      $remove_word = array('and','of','to','the','on','for','templates','unknown','not specified');
      ...
      $this->except_words = array('uk','ad','3d','dj','qr','hr','al','ul','up');
  ...
  public function getRecentMyDesign(Request $request_body)
  {
    try {
      ...
      $redis_result = Cache::rememberforever("getRecentMyDesign:$this->user_id:$this->page:$this->item_count", function () {
        ...
        return array('image_result' => isset($image_list) ? $image_list : []);
      });
      ...
      $response = Response::json(array('code' => 201, 'message' => config('constant.EXCEPTION_ERROR') . 'get recent designs.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
    ...
    try {
      ...
      $redis_result = Cache::rememberforever("getUpcomingEvents:$this->event_date", function () {
        ...
        if (($this->event_date)) {
          ...
          return array('result' => isset($data) ? $data : []);
        }
      });
      ...
      $response = Response::json(array('code' => 201, 'message' => config('constant.EXCEPTION_ERROR') . 'get post schedule.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
  ...
  public function getContentBySearchTag()
  {
    try {
      ...
      $redis_result = Cache::rememberforever("getContentBySearchTag:$this->user_keyword:$this->page:$this->item_count", function () {
        ...
        return array('user_keyword' => isset($this->user_keyword) ? $this->user_keyword : '', 'search_result' => isset($search_result) ? $search_result : []);
      });
      ...
      $response = Response::json(array('code' => 201, 'message' => config('constant.EXCEPTION_ERROR') . 'get content.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
  ...
  public function getContentBySearchTagWithCategory(Request $request_body)
  {
    try {
      ...
      $redis_result = Cache::rememberforever("getContentBySearchTagWithCategory:$this->user_keyword:$this->page:$this->item_count", function () {
        ...
        return array('user_keyword' => isset($this->user_keyword) ? $this->user_keyword : '', 'search_result' => isset($this->result) ? $this->result : []);
      });
  ...
  public function getUserKeyword()
  {
    try {
      ...
      $result = array('user_keyword' => isset($this->user_keyword) ? $this->user_keyword : '');
      $response = Response::json(array('code' => 200, 'message' => 'Keyword get successfully.', 'cause' => '', 'data' => $result));
  ...
  public function insertMyDesign(Request $request_body)
  {
    try {
      ...
      $response = Response::json(array('code' => 201, 'message' => config('constant.EXCEPTION_ERROR') . 'add template.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
