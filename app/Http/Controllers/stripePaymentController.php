...
class stripePaymentController extends Controller
{
    ...
    public function getAllProducts(Request $request_body)
    {
        ...
        try {
            ...
            $response = Response::json(['code' => 200, 'message' => 'Products fetched successfully.', 'cause' => '', 'data' => json_decode('{}')]);
        } catch (Exception $e) {
            (new ImageController())->logs('Stripe-DeleteProduct', $e);
            //      Log::error("Stripe-DeleteProduct : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'delete product.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
            DB::rollBack();
        }
    ...
    public function getAllPlansFromStripe(Request $request_body)
    {
        ...
        try {
            ...
            $response = Response::json(['code' => 200, 'message' => 'Plan fetched successfully.', 'cause' => '', 'data' => json_decode('{}')]);
        } catch (Exception $e) {
            (new ImageController())->logs('Stripe-getAllPlansFromStripe', $e);
            //      Log::error("Stripe-getAllPlansFromStripe : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'fetch plans.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
            DB::rollBack();
        }
    ...
    public function getAllPlansForUser(Request $request_body)
    {
        ...
        try {
            ...
            $response = Response::json(['code' => 200, 'message' => 'All plans fetched successfully.', 'cause' => '', 'data' => ['result' => $redis_result]]);
        } catch (Exception $e) {
            (new ImageController())->logs('Stripe-getAllPlansFromStripe', $e);
            //      Log::error("Stripe-getAllPlansFromStripe : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'fetch plans.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
    ...
    public function CreateStripePaymentMethod(Request $request_body)
    {
        try {
            ...
            if (($response = (new VerificationController())->validateRequiredParameter(['number', 'exp_month', 'exp_year', 'cvc', 'type'], $request)) != '') {
                return $response;
            }
            ...
            $response = Response::json(['code' => 200, 'message' => 'Thank you, your payment was successful.', 'cause' => '', 'data' => json_decode('{}')]);
        } catch (Exception $e) {
            (new ImageController())->logs('Stripe-DeleteProduct', $e);
            //      Log::error("Stripe-DeleteProduct : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'Create Stripe Payment Method.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
        }
    ...
    public function stripeUserPayment(Request $request_body)
    {
        ...
        try {
            ...
            if (($response = (new VerificationController())->validateRequiredParameter(['payment_method_response', 'plan_id'], $request)) != '') {
            ...
            if (count($result) > 0) {
                return Response::json(['code' => 419, 'message' => 'You are running one of the subscriptions, please unsubscribe or update your subscription with other plan.', 'cause' => '', 'data' => json_decode('{}')]);
            }
            ...
            if (! isset($customer_array['db_customer_id'])) {
                return Response::json(['code' => 201, 'message' => $customer_array['error_code'], 'cause' => '', 'data' => json_decode('{}')]);
            }
            ...
            if (! isset($subscription_array['db_subscription_id'])) {
                return Response::json(['code' => 201, 'message' => $subscription_array['error_code'], 'cause' => '', 'data' => json_decode('{}')]);
            }
            ...
            if (isset($subscription_array['error_status']) == 1) {
                return Response::json(['code' => 444, 'message' => 'Subscriptions require 3D secure authentication.', 'cause' => '', 'data' => ['client_secret' => $subscription_array['client_secret']]]);
            }
            ...
            if ($subscription_array['status'] == 'active') {
                ...
                /*$requestHeaders = apache_request_headers();
                $jwt_token = str_ireplace('Bearer ', '', $requestHeaders['Authorization']);*/
                $response = Response::json(['code' => 436, 'message' => 'Thank you, We have received your payment request and will respond within 24 hours.', 'cause' => '', 'data' => ['user_detail' => $user_detail]]);
            }
            ...
            $response = Response::json(['code' => 201, 'message' => 'PAK : it a decline,card exception will be caught.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
            ...
            $response = Response::json(['code' => 201, 'message' => 'PAK : Too many requests made to the API too quickly.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
            ...
            $response = Response::json(['code' => 201, 'message' => 'PAK : Invalid parameters were supplied to Stripe API.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
            ...
            $response = Response::json(['code' => 201, 'message' => 'PAK : Authentication with Stripe API failed.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
            ...
            $response = Response::json(['code' => 201, 'message' => 'PAK : Network communication with Stripe failed.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
            ...
            $response = Response::json(['code' => 201, 'message' => 'PAK : Display a very generic error to the user, and maybe send.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
            ...
            DB::insert('INSERT INTO stripe_error_master(user_id,api_name,error_type,description,error_json_response) VALUES(?, ?, ?, ?, ?)',
                [$user_id,
                    ...
                    $e->getMessage()]);
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'pay payment.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
            DB::rollBack();
        }
    ...
    //Create customer
    public function CreateCustomer($payment_method_id, $email_id, $user_id, $billing_info)
    {
        ...
        try {
            ...
            if (count($customer_exist) > 0) {
                ...
                $result = ['db_customer_id' => $db_customer_id,
    ...
    //Create subscription
    public function CreateSubscription($customer_id, $plan_id, $user_id, $actual_plan_id)
    {
        try {
            ...
            if (! isset($subscription->id)) {
                ...
                return ['error_code' => 'Unable to get subscription id from subscription array with 4##'];
            }
            ...
            if (isset($payment_error)) {
                ...
                return ['error_code' => $payment_error->message, 'error_status' => 1, 'client_secret' => 'No', 'last_payment_error' => $payment_error, 'type' => 'no type'];
            }
            ...
            if ($status == 'active') {
                ...
                if (isset($payment_intent)) {
                    ...
                    if ($payment_intent_status == 'requires_action') {
                        ...
                        $requires_action_array = ['error_status' => 1, 'client_secret' => $client_secret, 'last_payment_error' => $last_payment_error, 'type' => $error_type];
            ...
            $subscription_return = ['db_subscription_id' => $db_subscription_id,
    ...
    public function cancelStripeSubscription(Request $request_body)
    {
        try {
            ...
            if (count($sub_result) <= 0) {
                ...
                return $response = Response::json(['code' => 201, 'message' => 'You are not a Stripe Subscriber, please cancel a subscription using PayPal.', 'cause' => '', 'data' => json_decode('{}')]);
    ...
    public function createUpcomingInvoice(Request $request_body)
    {
        try {
            ...
            $user_id = JWTAuth::toUser($token)->id;
            $request = json_decode($request_body->getContent());
            if (($response = (new VerificationController())->validateRequiredParameter(['plan_id'], $request)) != '') {
                return $response;
            }
            ...
            if (count($sub_result) <= 0) {
                ...
                $response = $response = Response::json(['code' => 201, 'message' => 'You cannot preview the upcoming invoice for a canceled subscription..', 'cause' => '', 'data' => json_decode('{}')]);

            } elseif ($sub_result[0]->payment_type != 2) {

                $response = $response = Response::json(['code' => 201, 'message' => 'You are not a Stripe Subscriber, please update a subscription using PayPal.', 'cause' => '', 'data' => json_decode('{}')]);

            } elseif ($sub_result[0]->subscr_type == $plan_id) {

                $response = $response = Response::json(['code' => 201, 'message' => 'You are running on this same plan,please use a different plan to create a new invoice for the update subscription type.', 'cause' => '', 'data' => json_decode('{}')]);
                ...
                $invoice_array = ['customer_id' => $db_customer_id,
                    'amount' => $amount,
                ...
                $response = Response::json(['code' => 200, 'message' => 'The details of your next invoice have been successfully obtained.', 'cause' => '', 'data' => $invoice_details]);
            }
        } catch (Exception $e) {
            ...
            DB::insert('INSERT INTO stripe_error_master(user_id,api_name,error_type,description,error_json_response) VALUES(?, ?, ?, ?, ?)',
                [$user_id,
                    ...
                    $e->getMessage()]);
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'get invoice details.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
        }
    ...
    public function resubscribeStripeSubscription(Request $request_body)
    {
        try {
            ...
            if (count($sub_result) <= 0) {
                ...
                $response = $response = Response::json(['code' => 201, 'message' => 'You are not subscriber.', 'cause' => '', 'data' => json_decode('{}')]);
                ...
                $response = $response = Response::json(['code' => 201, 'message' => 'You are not able to activate your subscription with a different plan, please use the same plan to activate your existing subscription.', 'cause' => '', 'data' => json_decode('{}')]);

            } else {
                $is_active = $sub_result[0]->is_active;

                if ($is_active == 1) {
                    return $response = Response::json(['code' => 201, 'message' => 'Subscription is already running with an active subscription plan.', 'cause' => '', 'data' => json_decode('{}')]);
                }
                $subscription_id = $sub_result[0]->paypal_id;
                $total_amount = $sub_result[0]->total_amount;
                ...
                if ($subscription_array['status'] == 'active') {
                    ...
                    /*$requestHeaders = apache_request_headers();
                    $jwt_token = str_ireplace('Bearer ', '', $requestHeaders['Authorization']);*/
                    $response = Response::json(['code' => 200, 'message' => 'Your subscription is successfully activated.', 'cause' => '', 'data' => ['user_detail' => $user_detail]]);
            ...
            DB::insert('INSERT INTO stripe_error_master(user_id,api_name,error_type,description,error_json_response) VALUES(?, ?, ?, ?, ?)',
                [$user_id,
                    ...
                    $e->getMessage()]);
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'active subscription.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
        }

        return $response;
    }

    public function reActivatePlan($user_id, $subscription_id, $db_sub_id)
    {
        try {
            ...
            if ($subscription->status == 'canceled' && $current_period_end_date >= $sub_result[0]->expiration_time) {
                ...
                return Response::json(['code' => 200, 'message' => 'Subscription already canceled.', 'cause' => '', 'data' => $result]);
            } else {
                ...
                if ($status == 'active') {
                    ...
                    return ['plan_nickname' => $plan_nickname,
                        'plan_amount' => $amount,
                        'currency' => $currency,
                        'current_period_start' => $current_period_start,
                        'current_period_end' => $current_period_end,
        ...
        try {
            ...
            if (count($sub_result) <= 0) {
                ...
                if ($is_active == 1) {
                    ...
                    if (count($proration_details) <= 0) {
                        return Response::json(['code' => 201, 'message' => 'Please first find out the details of the proration amount, then update your subscription plan.', 'cause' => '', 'data' => json_decode('{}')]);
                    }
                    $is_active_user = 1;
                ...
                if (isset($subscription_array['error_status']) == 2) {
                    return Response::json(['code' => 444, 'message' => 'Subscriptions require 3D secure authentication.', 'cause' => '', 'data' => ['client_secret' => $subscription_array['client_secret'], 'invoice_url' => $subscription_array['hosted_invoice_url']]]);
                }
            ...
            DB::insert('INSERT INTO stripe_error_master(user_id,api_name,error_type,description,error_json_response) VALUES(?, ?, ?, ?, ?)',
                [$user_id,
                    ...
                    'unable to change subscription with stripe',
                    $e->getMessage()]);
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'change subscription.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
        }
    ...
    public function upgradeOrDowngradePlan($plan_id, $proration_date, $update_subscription_id, $user_id, $db_sub_id, $db_customer_id, $is_active_user, $client_secret)
    {
        ...
        if ($client_secret != '' && $status != 'active') {
            ...
            return $requires_action_array = ['error_status' => 2, 'client_secret' => $client_secret, 'hosted_invoice_url' => $hosted_invoice_url];
        }
        ...
        if ($update_subscription_id != $subscription_id) {
            ...
            return Response::json(['code' => 201, 'message' => 'Subscription does not match.', 'cause' => '', 'data' => json_decode('{}')]);
        }
        ...
        if ($status == 'active') {
            ...
            if (isset($payment_intent)) {
                ...
                if ($status == 'requires_action') {
                    $client_secret = $payment_intent->client_secret;
                    $requires_action_array = ['error_status' => 1, 'client_secret' => $client_secret];
                }
            } else {
                Log::error('Payment intent is not settled with INCOMPLETE status of subscription');
            }
        ...
        $subscription_return = ['plan_nickname' => $plan_nickname,
            'plan_amount' => $plan_amount,
            'txn_id' => $txn_id,
            'currency' => $currency,
            'current_period_start' => $current_period_start,
    ...
    public function SubscriptionMail($user_id, $user_name, $template, $subject, $message, $subscription_name, $txn_type, $subscr_id, $first_name, $payment_received_from, $total_amount, $mc_currency, $email, $payment_status, $activation_date, $next_billing_date, $api_name, $api_description, $invoice_url, $txn_id, $country_code = '')
    {
        try {
            ...
            return ['error code' => 'unable to send mail with 4##'];
        }
    }
    ...
    public function getPaymentStatusForUser(Request $request_body)
    {
        try {
            ...
            $request = json_decode($request_body->getContent());
            if (($response = (new VerificationController())->validateRequiredParameter(['payment_response'], $request)) != '') {
                return $response;
            }
            ...
            if ($status == 'succeeded') {
                ...
                if ($role_id == 2) {
                    $response = Response::json(['code' => 436, 'message' => 'Thank you, We have received your payment request and will respond within 24 hours.', 'cause' => '', 'data' => $user_detail]);
                } else {
                    $response = Response::json(['code' => 200, 'message' => 'Thank you, your payment was successful.', 'cause' => '', 'data' => $user_detail]);
                }
                ...
                /// ///////////////////////////////////////////////////
                $user_detail = (new LoginController())->getUserInfoByUserId($user_id);
                $response = Response::json(['code' => 436, 'message' => $message, 'cause' => '', 'data' => $user_detail]);
            } else {
                $user_detail = (new LoginController())->getUserInfoByUserId($user_id);
                $last_payment_error = $payment_response->last_payment_error;
                $message = $last_payment_error->message;
    ...
    */
    public function CreateProduct(Request $request_body)
    {
        ...
        try {
            ...
            if (($response = (new VerificationController())->validateRequiredParameter(['name', 'type'], $request)) != '') {
                return $response;
            }
            ...
            $response = Response::json(['code' => 200, 'message' => 'Stripe product created successfully.', 'cause' => '', 'data' => json_decode('{}')]);
        } catch (Exception $e) {
            (new ImageController())->logs('Stripe-CreateProduct', $e);
            //      Log::error("Stripe-CreateProduct : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'create product.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
            DB::rollBack();
        }
    ...
    public function UpdateProduct(Request $request_body)
    {
        ...
        try {
            ...
            $request = json_decode($request_body->getContent());
            //Log::info("request data :", [$request]);
            if (($response = (new VerificationController())->validateRequiredParameter(['id', 'name'], $request)) != '') {
                return $response;
            }
            ...
            $response = Response::json(['code' => 200, 'message' => 'Stripe product updated successfully.', 'cause' => '', 'data' => json_decode('{}')]);
        } catch (Exception $e) {
    ...
    public function DeleteProduct(Request $request_body)
    {
        ...
        try {
            ...
            $response = Response::json(['code' => 200, 'message' => 'Stripe product deleted successfully.', 'cause' => '', 'data' => json_decode('{}')]);
        } catch (Exception $e) {
            (new ImageController())->logs('Stripe-DeleteProduct', $e);
            //      Log::error("Stripe-DeleteProduct : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'delete product.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
