...
//      Log::error("addCategory : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
  ...
  public function updateCategory(Request $request_body)
  {
    try {
      ...
      if (count($result) > 0) {
        return $response = Response::json(array('code' => 201, 'message' => 'Category already exist.', 'cause' => '', 'data' => json_decode("{}")));
      } else {
        DB::beginTransaction();
        DB::update('UPDATE
                        category
...
//      Log::error("deleteCategory : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
  ...
  public function getAllCategory()
  {
    try {
      ...
      $response = Response::json(array('code' => 200, 'message' => 'All categories fetched successfully.', 'cause' => '', 'data' => ['result' => $redis_result]));
...
//      Log::error("getAllCategory : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
  ...
  public function addSubCategory(Request $request_body)
  {
    try {
      ...
      if (($response = (new VerificationController())->validateRequiredParameter(array('category_id', 'sub_category_name', 'is_featured'), $request)) != '')
        return $response;
...
//      Log::error("addSubCategory : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
  ...
  public function updateSubCategory(Request $request_body)
  {
    try {
      ...
      $request = json_decode($request_body->input('request_data'));
      if (($response = (new VerificationController())->validateRequiredParameter(array('sub_category_id', 'sub_category_name', 'is_featured'), $request)) != '')
        return $response;
    ...
    try {
      ...
      if (!Cache::has("Config::get('constant.REDIS_KEY'):getSubCategoryByCategoryIdForAdmin$this->category_id:$this->page:$this->item_count_sub_category")) {
        $result = Cache::rememberforever("getSubCategoryByCategoryIdForAdmin$this->category_id:$this->page:$this->item_count_sub_category", function () {
          ...
          return array('total_record' => $total_row, 'is_next_page' => $is_next_page, 'category_name' => $category_name, 'result' => $result);
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Sub category fetched successfully.', 'cause' => '', 'data' => $redis_result));
      $response->headers->set('Cache-Control', Config::get('constant.RESPONSE_HEADER_CACHE'));
...
//      Log::error("getSubCategoryByCategoryIdForAdmin : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . ' get sub categories.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
  ...
  public function searchSubCategoryByName(Request $request_body)
  {
    try {
      ...
      $request = json_decode($request_body->getContent());
      if (($response = (new VerificationController())->validateRequiredParameter(array('category_id', 'sub_category_name'), $request)) != '')
        return $response;
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Sub category search successfully.', 'cause' => '', 'data' => ['result' => $result]));
...
//      Log::error("addCatalog : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
  ...
  public function updateCatalog(Request $request_body)
  {
    try {
      ...
      if (($response = (new VerificationController())->validateRequiredParameter(array('category_id', 'sub_category_id', 'catalog_id', 'name', 'is_free', 'is_featured'), $request)) != '')
        return $response;
...
//      Log::error("updateCatalog : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
  ...
  public function deleteCatalog(Request $request_body)
  {
    try {
      ...
      if(count($details) > 0){
        $response = Response::json(array('code' => 201, 'message' => 'You are trying to delete catalog which have templates those are used in static page.', 'cause' => '', 'data' => json_decode('{}')));
        return $response;
      }
    ...
    try {
      ...
      if (!Cache::has("Config::get('constant.REDIS_KEY'):getCatalogBySubCategoryId$this->sub_category_id")) {
        $result = Cache::rememberforever("getCatalogBySubCategoryId$this->sub_category_id", function () {
          ...
          return array('total_record' => $total_row, 'category_name' => $category_name, 'result' => $result);
        });
      ...
      $response = Response::json(array('code' => 200, 'message' => 'All catalogs fetched successfully.', 'cause' => '', 'data' => $redis_result));
      $response->headers->set('Cache-Control', Config::get('constant.RESPONSE_HEADER_CACHE'));
...
//      Log::error("getCatalogBySubCategoryId : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
  ...
  public function searchCatalogByName(Request $request_body)
  {
    try {
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Catalog search successfully.', 'cause' => '', 'data' => ['result' => $result]));
...
//      Log::error("addNormalImages : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
  ...
  public function updateNormalImage(Request $request_body)
  {
    try {
      ...
      $request = json_decode($request_body->input('request_data'));
      if (($response = (new VerificationController())->validateRequiredParameter(array('category_id', 'content_id', 'search_category', 'is_featured'), $request)) != '')
        return $response;
  ...
  public function addSampleImages(Request $request_body)
  {
    ...
    try {
      ...
      if (!$request_body->hasFile('original_img') and !$request_body->hasFile('display_img')) {
        ...
        $response = Response::json(array('code' => 200, 'message' => 'Sample images added successfully.', 'cause' => '', 'data' => json_decode('{}')));
...
//      Log::error("addSampleImages : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'add sample images.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
  ...
  public function updateSampleImages(Request $request_body)
  {
    ...
    try {
      ...
      $request = json_decode($request_body->input('request_data'));
      if (($response = (new VerificationController())->validateRequiredParameter(array('category_id', 'content_id', 'image_type', 'is_featured'), $request)) != '')
        return $response;
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Sample images updated successfully.', 'cause' => '', 'data' => json_decode('{}')));
    } catch (Exception $e) {
...
//      Log::error("updateSampleImages : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
  ...
  public function getSampleImagesForAdmin(Request $request_body)
  {
    try {
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Sample images fetched successfully.', 'cause' => '', 'data' => ['result' => $redis_result]));
      $response->headers->set('Cache-Control', Config::get('constant.RESPONSE_HEADER_CACHE'));

    } catch (Exception $e) {
       (new ImageController())->logs("getSampleImagesForAdmin",$e);
//      Log::error("getSampleImagesForAdmin : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . ' get sample image.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
  ...
  public function deleteContentById(Request $request_body)
  {
    try {
      ...
      $request = json_decode($request_body->getContent());
      if (($response = (new VerificationController())->validateRequiredParameter(array('content_id'), $request)) != '')
        return $response;
      ...
      if(count($detail) > 0){
        $response = Response::json(array('code' => 201, 'message' => 'You are trying to delete template which is exist in static page.', 'cause' => '', 'data' => json_decode('{}')));
        return $response;
      }
...
//      Log::error("deleteContentById : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'delete content.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
  ...
  public function getContentByCatalogIdForAdmin(Request $request_body)
  {
    try {
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Content fetched successfully.', 'cause' => '', 'data' => ['result' => $redis_result]));
      $response->headers->set('Cache-Control', Config::get('constant.RESPONSE_HEADER_CACHE'));
...
//      Log::error("getContentByCatalogIdForAdmin : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
  ...
  public function getAllSubCategoryToLinkCatalog(Request $request)
  {
    try {
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Sub categories are fetched successfully.', 'cause' => '', 'data' => ['category_list' => $redis_result]));
      $response->headers->set('Cache-Control', Config::get('constant.RESPONSE_HEADER_CACHE'));
  ...
  public function linkCatalogToSubCategory(Request $request)
  {
    try {
      ...
      if (($response = (new VerificationController())->checkIfCatalogExist($sub_category_id, $catalog_name[0]->name, $catalog_id)) != '') {
        ...
        return $response = Response::json(array('code' => 201, 'message' => '"' . $catalog_name[0]->name . '" already exist in "' . $sub_category_name[0]->sub_category_name . '" category.', 'cause' => '', 'data' => json_decode("{}")));
      }
...
//      Log::error("getImageDetails : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
  ...
  public function addTemplateImages(Request $request_body)
  {
    try {
      ...
      if (($response = (new VerificationController())->validateRequiredParameter(array('is_replace','category_id'), $request)) != '')
        return $response;
      ...
      if($is_cdn_error){
          $response = Response::json(array('code' => 200, 'message' => 'Template images added successfully. Note: CDN cache not removed.', 'cause' => '', 'data' => json_decode('{}')));
      }else{
          $response = Response::json(array('code' => 200, 'message' => 'Template images added successfully.', 'cause' => '', 'data' => json_decode('{}')));
      }

    } catch (Exception $e) {
       (new ImageController())->logs("addTemplateImages",$e);
//      Log::error("addTemplateImages : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'add template images.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
  ...
  public function addTemplate(Request $request_body)
  {
    try {
      ...
      if (strstr($file_name, '.webp')) {
        $response = Response::json(array('code' => 200, 'message' => 'Template added successfully.', 'cause' => '', 'data' => json_decode('{}')));
      } else {
        $response = Response::json(array('code' => 200, 'message' => 'Template added successfully. Note: webp is not converted due to size grater than original.', 'cause' => '', 'data' => json_decode('{}')));
      }
  ...
  public function editTemplate(Request $request_body)
  {
    ...
    try {
      ...
      if ($request_body->hasFile('file')) {
        ...
        if (strstr($file_name, '.webp')) {
          $response = Response::json(array('code' => 200, 'message' => 'Template updated successfully.', 'cause' => '', 'data' => json_decode('{}')));
        } else {
          $response = Response::json(array('code' => 200, 'message' => 'Template updated successfully. Note: webp is not converted due to size grater than original.', 'cause' => '', 'data' => json_decode('{}')));
        }
      } else {
...
//      Log::error("editTemplate : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'edit template.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
  ...
  public function addText(Request $request_body)
  {
    try {
      ...
      if (strstr($file_name, '.webp')) {
        $response = Response::json(array('code' => 200, 'message' => 'Text json added successfully.', 'cause' => '', 'data' => json_decode('{}')));
      } else {
        $response = Response::json(array('code' => 200, 'message' => 'Text json added successfully. Note: webp is not converted due to size grater than original.', 'cause' => '', 'data' => json_decode('{}')));
      }
...
//      Log::error("addText : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'add text.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
  ...
  public function editText(Request $request_body)
  {
    ...
    try {
      ...
      if ($request_body->hasFile('file')) {
        ...
        if (strstr($file_name, '.webp')) {
          $response = Response::json(array('code' => 200, 'message' => 'Text updated successfully.', 'cause' => '', 'data' => json_decode('{}')));
        } else {
          $response = Response::json(array('code' => 200, 'message' => 'Text updated successfully. Note: webp is not converted due to size grater than original.', 'cause' => '', 'data' => json_decode('{}')));
        }
      } else {
...
//      Log::error("editText : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'edit text.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
  ...
  public function add3DObject(Request $request_body)
  {
    try {
      ...
      if (!$request_body->hasFile('file')) {
        ...
        if ($content_type == Config::get('constant.CONTENT_TYPE_OF_3D_TEXT_JSON')) {
          ...
          if (!$request_body->hasFile('content_file')) {
            return Response::json(array('code' => 201, 'message' => 'Required field content_file is missing or empty.', 'cause' => '', 'data' => json_decode("{}")));
          } else {
      ...
      if (strstr($file_name, '.webp')) {
        $response = Response::json(array('code' => 200, 'message' => '3D object added successfully.', 'cause' => '', 'data' => json_decode('{}')));
      } else {
        $response = Response::json(array('code' => 200, 'message' => '3D object added successfully. Note: webp is not converted due to size grater than original.', 'cause' => '', 'data' => json_decode('{}')));
      }
...
//      Log::error("add3DObject : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'add 3D object.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
  ...
  public function edit3DObject(Request $request_body)
  {
    ...
    try {
      ...
      if ($request_body->hasFile('file')) {
        ...
        if (strstr($file_name, '.webp')) {
          $response = Response::json(array('code' => 200, 'message' => '3D object updated successfully.', 'cause' => '', 'data' => json_decode('{}')));
        } else {
          $response = Response::json(array('code' => 200, 'message' => '3D object updated successfully. Note: webp is not converted due to size grater than original.', 'cause' => '', 'data' => json_decode('{}')));
        }
      } else {
        $object_image = "";
        $file_name = "";
...
//      Log::error("edit3DObject : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'edit 3D object.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
  ...
  public function addLink(Request $request_body)
  {
    try {
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Advertisement link added successfully.', 'cause' => '', 'data' => json_decode('{}')));
    } catch (Exception $e) {
...
//      Log::error("addLink : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
  ...
  public function updateLink(Request $request_body)
  {
    try {
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Advertisement link updated successfully.', 'cause' => '', 'data' => json_decode('{}')));
    } catch (Exception $e) {
...
//      Log::error("updateLink : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
  ...
  public function deleteLink(Request $request_body)
  {
    try {
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Advertisement link deleted successfully.', 'cause' => '', 'data' => json_decode('{}')));
    } catch (Exception $e) {
...
//      Log::error("deleteLink : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
  ...
  public function getAllAdvertisements(Request $request)
  {
    try {
      ...
      $response = Response::json(array('code' => 200, 'message' => 'All advertisements fetched successfully.', 'cause' => '', 'data' => $redis_result));
      $response->headers->set('Cache-Control', Config::get('constant.RESPONSE_HEADER_CACHE'));
    ...
    try {
      ...
      if (!Cache::has("Config::get('constant.REDIS_KEY'):getAllLink$this->sub_category_id:$this->page:$this->item_count")) {
        $result = Cache::rememberforever("getAllLink$this->sub_category_id:$this->page:$this->item_count", function () {
          ...
          $is_next_page = ($total_row > ($this->offset + $this->item_count)) ? true : false;
          return array('total_record' => $total_row, 'is_next_page' => $is_next_page, 'link_list' => $result);
      ...
      $response = Response::json(array('code' => 200, 'message' => 'All linked advertisements fetched successfully.', 'cause' => '', 'data' => $redis_result));
      $response->headers->set('Cache-Control', Config::get('constant.RESPONSE_HEADER_CACHE'));
  ...
  public function addTag(Request $request_body)
  {
    try {
      ...
      if(strlen($tag_name) >= 100) {
        return Response::json(array('code' => 201, 'message' => 'Invalid tag please enter valid tag.', 'cause' => '', 'data' => json_decode("{}")));
      }
      ...
      if ($total_row == 0) {
        return Response::json(array('code' => 201, 'message' => 'Templates do not exist having this tag.', 'cause' => '', 'data' => json_decode('{}')));
      }
      DB::beginTransaction();
...
//      Log::error("setTagRankOnTheTopByAdmin : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
    ...
    public function getDesignFolderForAdmin(Request $request_body)
    {
        try {
            ...
            $response = Response::json(array('code' => 200, 'message' => 'User images successfully retrieved.', 'cause' => '', 'data' => $redis_result));
            $response->headers->set('Cache-Control', Config::get('constant.RESPONSE_HEADER_CACHE'));

        } catch (Exception $e) {
            (new ImageController())->logs("getDesignFolderForAdmin", $e);
            //Log::error("getDesignFolderForAdmin : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'get design.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
            DB::rollBack();
        }
        return $response;
    }
    ...
    public function getVideoDesignFolderForAdmin(Request $request_body)
    {
        try {
            ...
            $response = Response::json(array('code' => 200, 'message' => 'User video design successfully obtained.', 'cause' => '', 'data' => $redis_result));
            $response->headers->set('Cache-Control', Config::get('constant.RESPONSE_HEADER_CACHE'));
    ...
    public function getIntroDesignFolderForAdmin(Request $request_body)
    {
        try {
            ...
            $response = Response::json(array('code' => 200, 'message' => 'User intro / video design successfully received.', 'cause' => '', 'data' => $redis_result));
            $response->headers->set('Cache-Control', Config::get('constant.RESPONSE_HEADER_CACHE'));
  ...
  public function getDesignByFolderIdForAdmin(Request $request_body)
  {
    try {
      ...
      $request = json_decode($request_body->getContent());
      if (($response = (new VerificationController())->validateRequiredParameter(array('page', 'item_count', 'folder_id', 'user_id'), $request)) != '')
        return $response;
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Designs fetched successfully.', 'cause' => '', 'data' => $redis_result));
      $response->headers->set('Cache-Control', Config::get('constant.RESPONSE_HEADER_CACHE'));

    } catch (Exception $e) {
       (new ImageController())->logs("getDesignByFolderIdForAdmin",$e);
//      Log::error("getDesignByFolderIdForAdmin : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'get design from folder.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
    ...
    try {
      ...
      if (!Cache::has("Config::get('constant.REDIS_KEY'):getAllUsersByAdmin$this->page:$this->item_count:$this->order_by:$this->order_type")) {
        $result = Cache::rememberforever("getAllUsersByAdmin$this->page:$this->item_count:$this->order_by:$this->order_type", function () {
          ...
          $is_next_page = ($total_row > ($this->offset + $this->item_count)) ? true : false;
          return array('total_record' => $total_row, 'is_next_page' => $is_next_page, 'result' => $result, 'role_list' => $role_list);
...
//      Log::error("getAllUsersByAdmin : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
  ...
  public function getAllUsersByAdmin(Request $request_body)
  {
    try {
      ...
      $response = Response::json([
        "code" => 201,
        "message" =>
          Config::get("constant.EXCEPTION_ERROR") . "get all user.",
        "cause" => $e->getMessage(),
        "data" => json_decode("{}"),
      ]);
    }
  ...
  public function searchUserForAdminBackup(Request $request_body)
  {
    try {
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Users fetched successfully.', 'cause' => '', 'data' => ['user_detail' => $result, 'role_list' => $role_list]));
...
//      Log::error("searchUserForAdmin : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
  ...
  public function searchUserForAdmin(Request $request_body)
  {
    try {
      ...
      $response = Response::json([
        "code" => 201,
        "message" =>
          Config::get("constant.EXCEPTION_ERROR") . " search user.",
        "cause" => $e->getMessage(),
        "data" => json_decode("{}"),
      ]);
    }
  ...
  public function getUserSessionInfo(Request $request)
  {
    try {
      ...
      $response = Response::json([
        "code" => 201,
        "message" =>
          Config::get("constant.EXCEPTION_ERROR") .
  ...
  public function changeUserRole(Request $request_body)
  {
    try {
      ...
      $request = json_decode($request_body->getContent());
      if (($response = (new VerificationController())->validateRequiredParameter(array('role_id', 'user_id'), $request)) != '')
        return $response;
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Role of the user changed successfully.', 'cause' => '', 'data' => json_decode('{}')));

    } catch (Exception $e) {
       (new ImageController())->logs("changeUserRole",$e);
//      Log::error("changeUserRole : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'change the role of a user.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
...
//      Log::error("getAllRole : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'get all role.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    ...
    try {
      ...
      if (!Cache::has("Config::get('constant.REDIS_KEY'):getFeedbackForObArm$this->last_sync_time")) {
        $result = Cache::rememberforever("getFeedbackForObArm$this->last_sync_time", function () {
          ...
          return array('total_record' => $total_row, 'result' => $result);
        });
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Feedback fetched successfully.', 'cause' => '', 'data' => $redis_result));
      $response->headers->set('Cache-Control', Config::get('constant.RESPONSE_HEADER_CACHE'));

    } catch (Exception $e) {
       (new ImageController())->logs("getFeedbackForObArm",$e);
//      Log::error("getFeedbackForObArm : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'get all feedback.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
    ...
    public function getAllFeedbackForObArm(Request $request_body)
    {
        try {
            ...
            $redis_result = Cache::remember("getAllFeedbackForObArm:$this->user_id:$this->order_by:$this->order_type:$this->search_type:$this->search_query", Config::get('constant.CACHE_TIME_24_HOUR'), function () {
                ...
                $result = array('total_row' => $total_row, 'feedback_result' => $feedback_result);
                return $result;
            ...
            $response = Response::json(array('code' => 200, 'message' => 'Feedback fetched successfully.', 'cause' => '', 'data' => $result));
            $response->headers->set('Cache-Control', Config::get('constant.RESPONSE_HEADER_CACHE'));
...
//      Log::error("getAllFeedback : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
  ...
  public function searchFeedback(Request $request_body)
  {
    try {
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Feedback fetched successfully.', 'cause' => '', 'data' => ['result' => $result]));

    } catch (Exception $e) {
       (new ImageController())->logs("searchFeedback",$e);
//      Log::error("searchFeedback : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . ' search feedback.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
  ...
  public function getGenerateVideoReportForAdmin(Request $request_body)
  {
    try {
      ...
      $redis_result = Cache::rememberforever("getGenerateVideoReportForAdmin:$this->start_date:$this->end_date:$this->page:$this->item_count", function () {
        ...
        return array('total_record' => $total_record, 'is_next_page' => $is_next_page, 'result' => $result);

      });

      $response = Response::json(array('code' => 200, 'message' => 'Download Video report successfully received.', 'cause' => '', 'data' => $redis_result));
      $response->headers->set('Cache-Control', Config::get('constant.RESPONSE_HEADER_CACHE'));

    } catch (Exception $e) {
      (new ImageController())->logs("getGenerateVideoReportForAdmin", $e);
      //Log::error("getGenerateVideoReportForAdmin : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'received video report .', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
  ...
  public function getSummaryByAdmin(Request $request_body)
  {
    try {
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Summary fetched successfully.', 'cause' => '', 'data' => ['total_record' => $total_row, 'is_next_page' => $is_next_page, 'result' => $result]));
...
//      Log::error("getSummaryByAdmin : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
  ...
  public function searchSummaryByAdmin(Request $request_body)
  {
    try {
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Summary fetched successfully.', 'cause' => '', 'data' => ['result' => $result]));

    } catch (Exception $e) {
       (new ImageController())->logs("searchSummaryByAdmin",$e);
//      Log::error("searchSummaryByAdmin : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'search summary.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
  ...
  public function getCatalogWithDetailBySubCategoryId(Request $request_body)
  {
    try {
      ...
      $request = json_decode($request_body->getContent());
      if (($response = (new VerificationController())->validateRequiredParameter(array('page', 'item_count', 'sub_category_id'), $request)) != '')
        return $response;
      ...
      if (!Cache::has("Config::get('constant.REDIS_KEY'):getCatalogWithDetailBySubCategoryId:$this->sub_category_id:$this->page:$this->item_count:$this->order_by:$this->order_type")) {
        $result = Cache::rememberforever("getCatalogWithDetailBySubCategoryId:$this->sub_category_id:$this->page:$this->item_count:$this->order_by:$this->order_type", function () {
          ...
          return array('total_record' => $total_row, 'is_next_page' => $is_next_page, 'catalog_result' => $result);
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Catalog Fetch successfully .', 'cause' => '', 'data' => $redis_result));
      $response->headers->set('Cache-Control', Config::get('constant.RESPONSE_HEADER_CACHE'));
...
//      Log::error("getCatalogWithDetailBySubCategoryId : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'get catalog name.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
  ...
  public function getAllTransactionsForAdmin(Request $request)
  {
    try {
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Transactions fetched successfully.', 'cause' => '', 'data' => $redis_result));


    } catch (Exception $e) {
       (new ImageController())->logs("getAllTransactionsForAdmin",$e);
//      Log::error("getAllTransactionsForAdmin : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'get all transactions.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
...
//                                      WHERE result.' . $search_type . ' LIKE ?', [$search_query]);
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Transactions fetched successfully.', 'cause' => '', 'data' => ['result' => $result]));

    } catch (Exception $e) {
       (new ImageController())->logs("searchTransaction",$e);
//      Log::error("searchTransaction : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'search transaction.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
  ...
  public function verifyTransaction(Request $request)
  {
    ...
    try {
      ...
      if (($response = (new VerificationController())->validateRequiredParameter(array('txn_id'), $request)) != '')
        return $response;
...
//              Log::info('Transaction verification  : ',[$stripe_subscription]);
              ...
              $result = array("RECEIVERBUSINESS" => "Not applicable",
              ...
              return $response = Response::json(array('code' => 201, 'message' => 'Unable to fetch transaction source.', 'cause' => '', 'data' => json_decode("{}")));
          }
      } else {
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Transaction details fetched successfully.', 'cause' => '', 'data' => $result));


    } catch (Exception $e) {
       (new ImageController())->logs("verifyTransaction",$e);
//      Log::error("verifyTransaction : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'verify transaction.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
...
//      Log::error("confirmPaymentByAdmin : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'confirm payment.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  ...
  public function addFont(Request $request_body)
  {
    try {
      ...
      if (!$request_body->hasFile('font_json_file'))
        return Response::json(array('code' => 201, 'message' => 'Required field font_json_file is missing or empty.', 'cause' => '', 'data' => json_decode("{}")));
      ...
      if (!$request_body->hasFile('font_preview_image'))
        return Response::json(array('code' => 201, 'message' => 'Required field font_preview_image is missing or empty.', 'cause' => '', 'data' => json_decode("{}")));
      ...
      $response = Response::json(array('code' => 201, 'message' => config('constant.EXCEPTION_ERROR') . 'add font.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
  ...
  public function editFont(Request $request_body)
  {
    try {
      ...
      if (isset($request->issue_code)) {
        ...
        if (($response = (new VerificationController())->validateRequiredParameter(array('is_update_all', 'catalog_id'), $request)) != '')
          return $response;
      ...
      if (count($font_detail) > 0) {
        ...
        $response = Response::json(array('code' => 201, 'message' => 'Font does not exist.', 'cause' => '', 'data' => json_decode('{}')));
      }
    } catch (Exception $e) {
      (new ImageController())->logs("editFont", $e);
      $response = Response::json(array('code' => 201, 'message' => config('constant.EXCEPTION_ERROR') . 'edit font.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
...
//      Log::error("getAllFontsByCatalogIdForAdmin : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
  ...
  public function generateSearchTagByAI(Request $request_body)
  {
    try {
      ...
      $request = json_decode($request_body->input('request_data'));
      if (($response = (new VerificationController())->validateRequiredParameter(array('font_file_name'), $request)) != '')
        return $response;
      ...
      if($code === 200) {
        $response = Response::json(array('code' => 200, 'message' => 'Search tag generated successfully.', 'cause' => '', 'data' => $result->data));
      } else {
        $response = Response::json(array('code' => $code, 'message' => 'Unable to generate search tag.', 'cause' => '', 'data' => json_decode("{}")));
      }

    } catch (Exception $e) {
      (new ImageController())->logs("generateSearchTagByAI", $e);
      $response = Response::json(array('code' => 201, 'message' => config('constant.EXCEPTION_ERROR') . 'generate search tag.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
...
//            Log::error("generatePreviewImageForUploadedFonts unable to generate images : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      ...
      $result_array = array('total_records_to_update' => $total_fonts[0]->total, 'generated_images' => $generated_images, 'remaining_images' => $remaining_images);
      $result = json_decode(json_encode($result_array), true);

      $response = Response::json(array('code' => 200, 'message' => 'Preview image generated successfully.', 'cause' => '', 'data' => $result));

    } catch (Exception $e) {
       (new ImageController())->logs("generatePreviewImageForUploadedFonts",$e);
//      Log::error("generatePreviewImageForUploadedFonts : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'generate preview image.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
  ...
  public function editStaticFontPathInToJson(Request $request)
  {
    try {
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Json edited successfully.', 'cause' => '', 'data' => json_decode('{}')));

    } catch (Exception $e) {
       (new ImageController())->logs("editStaticFontPathInToJson",$e);
//      Log::error("editStaticFontPathInToJson : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'edit static fontPath into json.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
...
//      Log::error("setCatalogRankOnTheTopByAdmin : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
  ...
  public function setCatalogRankOnTheTopByAdmin(Request $request_body)
  {
    try {
      ...
      $request = json_decode($request_body->getContent());
      if (($response = (new VerificationController())->validateRequiredParameterIsArray(array('catalog_ids'), $request)) != '')
        return $response;
...
//      Log::error("setContentRankOnTheTopByAdmin : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
  ...
  public function generateAllImagesForUserUploads(Request $request)
  {
    try {
      ...
      $request = json_decode($request->getContent());
      if (($response = (new VerificationController())->validateRequiredParameter(array('item_count', 'page', 'no_of_times_update'), $request)) != '')
        return $response;
...
//              Log::error("generateAllImagesForBkgVideos unable to generate images : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      ...
      $result_array = array('total_records_to_update' => $total_row_result[0]->total, 'uploaded_images' => $updated_images, 'remaining_images' => $remaining_images);
      $result = json_decode(json_encode($result_array), true);

      $response = Response::json(array('code' => 200, 'message' => 'Image generated successfully.', 'cause' => '', 'data' => $result));
...
//      Log::error("generateAllImagesForUserUploads : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'generate all images for user uploads.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
  ...
  public function getUsersMaxDesign(Request $request_body)
  {
    try {
      ...
      $request = json_decode($request_body->getContent());
      if (($response = (new VerificationController())->validateRequiredParameter(array('user_limit'), $request)) != '')
        return $response;
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Users design fetch Successfully.', 'cause' => '', 'data' => $result));

    } catch (Exception $e) {
      Log::error("getUsersMaxDesign : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => config('constants.EXCEPTION_ERROR') . 'fetch user design.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
  ...
  public function getUsersDailyDesign(Request $request_body)
  {
    try {
      ...
      $request = json_decode($request_body->getContent());
      if (($response = (new VerificationController())->validateRequiredParameter(array('days'), $request)) != '')
        return $response;
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Users daily design fetch Successfully.', 'cause' => '', 'data' => $final_response_array));

    } catch (Exception $e) {
      Log::error("getUsersDailyDesign : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => config('constants.EXCEPTION_ERROR') . 'fetch user daily design.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
  ...
  public function getUserSessionDetails(Request $request_body)
  {
    try {
      ...
      $request = json_decode($request_body->getContent());
      if (($response = (new VerificationController())->validateRequiredParameter(array('start_date', 'end_date'), $request)) != '')
        return $response;
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Users design fetch Successfully.', 'cause' => '', 'data' => $final_results));

    } catch (Exception $e) {
      Log::error("getUserSessionDetails : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => config('constant.EXCEPTION_ERROR') . 'fetch user design.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
...
//      Log::error("deleteRedisKeys : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
  ...
  public function deleteAllRedisKeysByKeyName(Request $request_body)
  {
    try {
      ...
      if(!in_array("$this_ip", $arr_ip, true)){
        return Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'delete redis keys.', 'cause' => "Unauthorised IP", 'data' => json_decode("{}")));
      }
  ...
  public function getAllRedisKeysByKeyName(Request $request_body)
  {
    try {
      ...
      $this_ip = $_SERVER['HTTP_X_FORWARDED_FOR'];
      if(!in_array("$this_ip", $arr_ip, true)){
        return Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'run these Query.', 'cause' => "Unauthorised IP", 'data' => json_decode("{}")));
      }
  ...
  public function getRandomRedisKeys(Request $request_body)
  {
    try {
      ...
      $this_ip = $_SERVER['HTTP_X_FORWARDED_FOR'];
      if(!in_array("$this_ip", $arr_ip, true)){
        return Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'get random redis keys.', 'cause' => "Unauthorised IP", 'data' => json_decode("{}")));
      }
  ...
  public function getRedisKeyValueByKeyName(Request $request_body)
  {
    try {
      ...
      $this_ip = $_SERVER['HTTP_X_FORWARDED_FOR'];
      if(!in_array("$this_ip", $arr_ip, true)){
        return Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'get this redis key.', 'cause' => "Unauthorised IP", 'data' => json_decode("{}")));
      }
  ...
  public function getDatabaseInfo(Request $request_body)
  {
    try {
      ...
      if(!($this->validateQuery($query))){
        return Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'get database information.', 'cause' => 'Queries involving DELETE, DROP, or TRUNCATE are strictly prohibited.', 'data' => json_decode("{}")));
      }
      ...
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'run these Query.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
  ...
  public function checkFileExistWithFOpen(Request $request)
  {
    try {
      ...
      if (fopen($url, "r")) {
        ...
        $response = Response::json(array('code' => 200, 'message' => 'File fetched successfully.', 'cause' => '', 'data' => json_decode("{}")));
      } else {
        $response = Response::json(array('code' => 201, 'message' => 'File not fetched successfully.', 'cause' => '', 'data' => json_decode("{}")));
...
//      Log::error("checkFileExistWithFOpen : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'check file exist using fopen.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
...
//      Log::error("checkFileExistWithFileExist : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'check file exist using file_exist.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
  ...
  public function saveImageIntoS3(Request $request_body)
  {
    try {
      ...
      $request = json_decode($request_body->input('request_data'));
      if (($response = (new VerificationController())->validateRequiredParameter(array('is_replace', 'directory_name'), $request)) != '')
        return $response;
      ...
      if ($request_body->hasFile('file')) {
        ...
        if ($is_replace == 1) {
          if ($disk->exists($original_targetFile) == True) {
            return Response::json(array('code' => 201, 'message' => 'File is already exist.', 'cause' => '', 'data' => json_decode("{}")));
          }
        }
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Save image into s3 successfully.', 'cause' => '', 'data' => ['url' => $url]));

    } catch
    (Exception $e) {
       (new ImageController())->logs("saveImageIntoS3",$e);
//      Log::error("saveImageIntoS3 : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'save image into s3.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
  ...
  public function addNormalVideos(Request $request_body)
  {
    try {
      ...
      if (!$request_body->hasFile('file')) {
        ...
        DB::commit();
        $response = Response::json(array('code' => 200, 'message' => 'Normal videos added successfully.', 'cause' => '', 'data' => json_decode('{}')));
      }
    } catch (Exception $e) {
       (new ImageController())->logs("addNormalVideos",$e);
//      Log::error("addNormalVideos : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'add normal videos.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
  ...
  public function updateNormalVideo(Request $request_body)
  {
    try {
      ...
      if (($response = (new VerificationController())->validateRequiredParameter(array('content_id', 'search_category'), $request)) != '')
        return $response;
      ...
      if (count($content) <= 0) {
        return Response::json(array('code' => 201, 'message' => 'Normal video does not exist.', 'cause' => '', 'data' => json_decode("{}")));
      }
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Normal video updated successfully.', 'cause' => '', 'data' => json_decode('{}')));

    } catch (Exception $e) {
       (new ImageController())->logs("updateNormalVideo",$e);
//      Log::error("updateNormalVideo : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'update video.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
  ...
  public function deleteNormalVideoByAdmin(Request $request_body)
  {
    try {
      ...
      if (count($result) > 0) {
        ...
        $response = Response::json(array('code' => 200, 'message' => 'Normal video deleted successfully.', 'cause' => '', 'data' => json_decode('{}')));
      } else {
        $response = Response::json(array('code' => 201, 'message' => 'Normal video does not exist.', 'cause' => '', 'data' => json_decode('{}')));
      }
    } catch (Exception $e) {
       (new ImageController())->logs("deleteNormalVideoByAdmin",$e);
//      Log::error("deleteNormalVideoByAdmin : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'delete normal video by admin.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
  ...
  public function uploadJsonVideos(Request $request_body)
  {
    try {
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Json videos uploaded successfully.', 'cause' => '', 'data' => json_decode('{}')));
    } catch
    (Exception $e) {
       (new ImageController())->logs("uploadJsonVideos",$e);
//      Log::error("uploadJsonVideos : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'upload json videos.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
  ...
  public function addJsonVideoByAdmin(Request $request_body)
  {
    try {
      ...
      if (!$request_body->hasFile('transparent_image'))
        return Response::json(array('code' => 201, 'message' => 'Required field transparent_image is missing or empty.', 'cause' => '', 'data' => json_decode("{}")));

      $request = json_decode($request_body->input('request_data'));
      if (($response = (new VerificationController())->validateRequiredParameter(array('video_name', 'catalog_id', 'is_featured', 'is_free', 'json_data','search_category'), $request)) != '')
        return $response;
...
//      }
      ...
      if ($result['result_status'] == 0) {
        $response = Response::json(array('code' => 201, 'message' => 'Json is unable to preview video', 'cause' => '', ['preview_id' => $prv_id, 'content_id' => $content_id,'template_detail' => $template_details]));
      } else {
        $preview_id = $result['preview_id'];
        $response = Response::json(array('code' => 200, 'message' => 'Json added successfully.', 'cause' => '', 'data' => ['preview_id' => $preview_id, 'content_id' => $content_id,'template_detail' => $template_details ]));
      }
    } catch
    (Exception $e) {
       (new ImageController())->logs("addJsonVideoByAdmin",$e);
//      Log::error("addJsonVideoByAdmin : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'add json by admin.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
  ...
  public function editJsonVideoByAdmin(Request $request_body)
  {
    try {
      ...
      $request = json_decode($request_body->input('request_data'));
      if (($response = (new VerificationController())->validateRequiredParameter(array('content_id', 'catalog_id', 'is_featured', 'is_free', 'json_data', 'template_name'), $request)) != '')
        return $response;
      ...
      if ($video_name OR $request_body->hasFile('transparent_image')) {
        ...
        if (($response = (new VerificationController())->validateRequiredParameter(array('video_name'), $request)) != '')
          return $response;
...
//        Log::info('preview_height_width', [$dimension['height'], $dimension['width']]);
        ...
        if ($result['result_status'] == 0) {
          $response = Response::json(array('code' => 201, 'message' => 'Json is unable to preview video', 'cause' => '', 'data' => ['preview_id' => $prv_id, 'content_id' => $content_id,'template_detail' => $template_details]));
        } else {
          $preview_id = $result['preview_id'];
          $response = Response::json(array('code' => 200, 'message' => 'Json updated successfully. ', 'cause' => '', 'data' => ['preview_id' => $preview_id, 'content_id' => $content_id,'template_detail' => $template_details]));
        }
...
//        }
        ...
        $response = Response::json(array('code' => 200, 'message' => 'Json updated successfully.', 'cause' => '', 'data' => ['preview_id' => 0, 'content_id' => 0]));
      }
...
//      Log::error("editJsonVideoByAdmin : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'edit json by admin.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
  ...
  public function updateVideoTemplateDetail(Request $request_body)
  {
    try {
      ...
      $request = json_decode($request_body->getContent());
      if (($response = (new VerificationController())->validateRequiredParameter(array('content_id', 'is_featured', 'is_free', 'template_name'), $request)) != '')
        return $response;
      ...
      if (count($result) <= 0) {
        return $response = Response::json(array('code' => 201, 'message' => 'Template does not exist.', 'cause' => '', 'data' => json_decode("{}")));
      } else {
        DB::beginTransaction();
        DB::update('UPDATE content_master
                        SET
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Video template updated successfully.', 'cause' => '', 'data' => json_decode('{}')));

    } catch (Exception $e) {
       (new ImageController())->logs("updateVideoTemplateDetail",$e);
//      Log::error("updateVideoTemplateDetail : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'update a video template detail.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
...
//        $video_name = $result[0]->template_video;
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Json video deleted successfully.', 'cause' => '', 'data' => json_decode('{}')));
    } catch (Exception $e) {
       (new ImageController())->logs("deleteJsonVideoByAdmin",$e);
//      Log::error("deleteJsonVideoByAdmin : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'delete json video by admin.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
  ...
  public function checkReadyToPreviewVideo(Request $request_body)
  {
    try {
      ...
      $request = json_decode($request_body->getContent());
      if (($response = (new VerificationController())->validateRequiredParameter(array('preview_id'), $request)) != '')
        return $response;
...
//      Log::error("checkReadyToPreviewVideo : ", ['Exception' => $e->getMessage(), "\nTraceAsString :" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'check ready to preview video.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
  ...
  public function getPreviewVideoDetail(Request $request_body)
  {
    try {
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Detail fetched successfully.', 'cause' => '', 'data' => ['result' => $result]));

    } catch (Exception $e) {
       (new ImageController())->logs("getPreviewVideoDetail",$e);
//      Log::error("getPreviewVideoDetail : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'details preview video.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
...
//        Log::info("reducePreviewVideo results : ", [$result]);
        if (file_exists($new_preview_video) && $result == 0) {
          ...
          $response = Response::json(array('code' => 200, 'message' => 'Preview video generated successfully.', 'cause' => '', 'data' => json_decode('{}')));
        } else {
          Log::error("reducePreviewVideo handle()_output : ", [$output]);
          Log::error("reducePreviewVideo handle()_result : ", [$result]);
          $response = Response::json(array('code' => 201, 'message' => "Sorry, we couldn't generate preview video. Please try again", 'cause' => '', 'data' => json_decode('{}')));
        }
      } else {
        $response = Response::json(array('code' => 201, 'message' => "Sorry, we couldn't generate preview video. Please try again", 'cause' => '', 'data' => json_decode('{}')));
      }
...
//      Log::error("reducePreviewVideo : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'reduce preview video.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
  ...
  public function retryToGenerateVideo(Request $request_body)
  {
    try {
      ...
      $request = json_decode($request_body->getContent());
      if (($response = (new VerificationController())->validateRequiredParameter(array('preview_id', 'content_id'), $request)) != '')
        return $response;
      ...
      if ($result['result_status'] == 0) {
        $response = Response::json(array('code' => 201, 'message' => 'Video is unable to preview video', 'cause' => '', 'data' => ['preview_id' => $preview_id, 'content_id' => $content_id]));
      } else {
        $preview_id = $result['preview_id'];
        $response = Response::json(array('code' => 200, 'message' => 'Preview video generated successfully.', 'cause' => '', 'data' => ['preview_id' => $preview_id, 'content_id' => $content_id]));
      }

    } catch (Exception $e) {
       (new ImageController())->logs("retryToGenerateVideo",$e);
//      Log::error("retryToGenerateVideo : ", ['Exception' => $e->getMessage(), "\nTraceAsString :" => $e->getTraceAsString()]);
       $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'retry to generate video.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
  /* =========================================| Catalog audio |========================================= */
  ...
  public function addNormalAudio(Request $request_body)
  {
    try {
      ...
      if (($response = (new VerificationController())->validateRequiredParameter(array('category_id','catalog_id', 'tag', 'title'), $request)) != '')
        return $response;
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Normal audio added successfully.', 'cause' => '', 'data' => json_decode('{}')));
    } catch (Exception $e) {
       (new ImageController())->logs("addNormalAudio",$e);
//      Log::error("addNormalAudio : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'add audio by admin.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
  ...
  public function updateNormalAudio(Request $request_body)
  {
    try {
      ...
      if (($response = (new VerificationController())->validateRequiredParameter(array('category_id','content_id', 'tag', 'title'), $request)) != '')
        return $response;
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Audio updated successfully.', 'cause' => '', 'data' => json_decode('{}')));

    } catch (Exception $e) {
       (new ImageController())->logs("updateNormalAudio",$e);
//      Log::error("updateNormalAudio : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'update audio by admin.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
  ...
  public function deleteNormalAudioByAdmin(Request $request_body)
  {
    try {
      ...
      if (count($result) > 0) {
        ...
        $response = Response::json(array('code' => 200, 'message' => 'Normal audio deleted successfully.', 'cause' => '', 'data' => json_decode('{}')));
      } else {
        $response = Response::json(array('code' => 201, 'message' => 'Normal audio does not exist.', 'cause' => '', 'data' => json_decode('{}')));
      }
    } catch (Exception $e) {
       (new ImageController())->logs("deleteNormalAudioByAdmin",$e);
//      Log::error("deleteNormalAudioByAdmin : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'delete normal audio by admin.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
...
//      Log::error("getTagFromImage : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
    ...
    */
    public function getTemplateBySearchTag(Request $request_body)
    {
        try {
            ...
            $request = json_decode($request_body->getContent());
            if (($response = (new VerificationController())->validateRequiredParameter(array('search_category', 'page'), $request)) != '')
            return $response;
            ...
            $redis_result = Cache::rememberforever("getTemplateBySearchTag:$this->content_type:$this->search_category:$this->page:$this->item_count", function () {
                ...
                $is_next_page = ($total_row > ($this->offset + $this->item_count)) ? true : false;
                $result = array('total_record' => $total_row, 'is_next_page' => $is_next_page, 'result' => $search_result);
  ...
  public function updateSearchTagTemplates(Request $request_body)
  {
    try {
      ...
      $request = json_decode($request_body->getContent());
      if (($response = (new VerificationController())->validateRequiredParameter(array('tag_id','tag'), $request)) != '')
        return $response;
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Search tag templates updated successfully.', 'cause' => '', 'data' => json_decode("{}")));

    } catch (Exception $e) {
      (new ImageController())->logs("updateSearchTagTemplates", $e);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'update search tag templates.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
  ...
  public function getUserPublishDesignForAdmin(Request $request_body)
  {
    try {
      ...
      $request = json_decode($request_body->getContent());
      if (($response = (new VerificationController())->validateRequiredParameter(array('is_publish','content_type','page','item_count'), $request)) != '')
        return $response;
      ...
      if (!Cache::has("Config::get('constant.REDIS_KEY'):getUserPublishDesignForAdmin$this->is_publish:$this->page:$this->item_count:$this->is_publish:$this->user_id:$this->content_type")) {
        $result = Cache::rememberforever("getUserPublishDesignForAdmin$this->is_publish:$this->page:$this->item_count:$this->is_publish:$this->user_id:$this->content_type", function () {
          ...
          $is_next_page = ($total_row > ($this->offset + $this->item_count)) ? true : false;
          return array('total_record' => $total_row, 'is_next_page' => $is_next_page, 'result' => $design);
        });
      }
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Design fetched successfully.', 'cause' => '', 'data' => $redis_result));
      $response->headers->set('Cache-Control', Config::get('constant.RESPONSE_HEADER_CACHE'));

    } catch (Exception $e) {
       (new ImageController())->logs("getUserPublishDesignForAdmin",$e);
//      Log::error("getUserPublishDesignForAdmin : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . ' get user publish design.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
  ...
  public function publishUserDesignByAdmin(Request $request_body)
  {
    try {
      ...
      $request = json_decode($request_body->input('request_data'));
      if (($response = (new VerificationController())->validateRequiredParameter(array('is_publish','design_id','content_type'), $request)) != '')
        return $response;
      ...
      if($is_publish == 1){
        ...
        $response = Response::json(array('code' => 200, 'message' => 'Design publish successfully.', 'cause' => '', 'data' => json_decode("{}")));
      }else{
        DB::beginTransaction();
        ...
        $response = Response::json(array('code' => 200, 'message' => 'Design rejected successfully.', 'cause' => '', 'data' => json_decode("{}")));
      }
    } catch (Exception $e) {
...
//      Log::error("publishUserDesignByAdmin : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
  ...
  public function getSubCategoryByAppIdForAutoUpload(Request $request_body)
  {
    try {
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Sub Category fetched successfully.', 'cause' => '', 'data' => ['category_list' => $redis_result]));
      $response->headers->set('Cache-Control', Config::get('constant.RESPONSE_HEADER_CACHE'));
...
//      Log::error("getSubCategoryByAppIdForAutoUpload : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'get sub category.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
...
//          }
          ...
          return array('result' => $list_of_validations, 'category_id' => NULL, 'is_multi_page_support' => 1);
...
//      Log::error("getAllValidationsForAdminForAutoUpload : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
  ...
  public function autoUploadTemplate(Request $request_body)
  {
    try {
      ...
      $request = json_decode($request_body->getContent());
      if (($response = (new VerificationController())->validateRequiredParameter(array('zip_url', 'zip_name', 'catalog_id', 'is_featured', 'is_free', 'search_category', 'template_name'), $request)) != '')
        return $response;
...
//            }
      ...
      if ($zip->open($zip_store_path) === true) {
        for ($i = 0; $i < $zip->numFiles; $i++) {
          ...
          if ($filesize > 0) {
            ...
            } else if (($extension == "jpg" || $extension == "png" || $extension == "jpeg") && $error_msg == "" ) {
      ...
      if (empty($video_file_array) && $content_type == Config::get('constant.VIDEO')) {
        return Response::json(array('code' => 201, 'message' => 'Required file resource video is missing in zip file.', 'cause' => '', 'data' => json_decode("{}")));
      }
      ...
      if($content_type == Config::get('constant.VIDEO')){
        if($preview_video) {
          ...
          return Response::json(array('code' => 201, 'message' => 'Required file preview video is missing or empty.', 'cause' => '', 'data' => json_decode("{}")));
        }
      }
...
//      Log::error("autoUploadTemplate : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
  ...
  public function autoUploadTemplateV3(Request $request_body)
  {
    try {
        ...
        $request = json_decode($request_body->getContent());
        if (($response = (new VerificationController())->validateRequiredParameter(array('zip_url', 'zip_name', 'catalog_id', 'is_featured', 'is_portrait', 'is_free', 'search_category'), $request)) != '')
            return $response;
  ...
  public function autoUploadTemplateV2(Request $request_body)
  {
    try {
        ...
        $request = json_decode($request_body->getContent());
        if (($response = (new VerificationController())->validateRequiredParameter(array('zip_url', 'zip_name', 'catalog_id', 'is_featured', 'is_portrait', 'is_free', 'search_category','json_pages_sequence', 'template_name'), $request)) != '')
            return $response;
      ...
      if (count($resource_image_array) > 0) {
        ...
        foreach ($all_json_data AS $i => $json_data) {
            ...
            $multiple_images[$i] = array("name"=>$catalog_image,"webp_name"=>$file_name,"width"=>$dimension['width'], "height"=>$dimension['height'] );
    ...
    public function editDataInXMLFileBackUp(Request $request_body)
    {
        try {
            ...
            if (!$request_body->hasFile('file')) {
                return Response::json(array('code' => 201, 'message' => 'Required field xml file is missing or empty.', 'cause' => '', 'data' => json_decode("{}")));
            }
            ...
            $response = Response::json(array('code' => 200, 'message' => 'File updated successfully.', 'cause' => '', 'data' => $result));

        } catch (Exception $e) {
            (new ImageController())->logs("editDataInXMLFile",$e);
            //Log::error("editDataInXMLFile : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'update data.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
        }
        return $response;
    }
    ...
    */
    public function editDataInXMLFile(Request $request_body)
    {
        try {
            ...
            if (($response = (new VerificationController())->validateRequiredParameter(array('page_url', 'is_new_file'), $request)) != '')
                return $response;
            ...
            if($is_new_file && file_exists($filename)){
                return Response::json(array('code' => 201, 'message' => 'File is already exist on this path.', 'cause' => '', 'data' => json_decode("{}")));

            }elseif ($is_new_file != 1 && !file_exists($filename)){
                return Response::json(array('code' => 201, 'message' => 'No such file or directory exist on this path.', 'cause' => '', 'data' => json_decode("{}")));
    ...
    */
    public function getDataFromXMLFile(Request $request_body)
    {
        try {
            ...
            $request = json_decode($request_body->getContent());
            if (($response = (new VerificationController())->validateRequiredParameter(array('page_url'), $request)) != '')
                return $response;
            ...
            if(file_exists($filename)) {
                $result = file_get_contents($filename);
                $response = Response::json(array('code' => 200, 'message' => 'File data get successfully.', 'cause' => '', 'data' => $result));
    ...
    public function verifyURLForDesignPageCreation(Request $request_body)
    {
        try {
            ...
            if(substr_count($page_url,"/") > 3) {
                return Response::json(array('code' => 201, 'message' => 'Url must be of parent/child or parent format.', 'cause' => '', 'data' => json_decode("{}")));
            }

            if(file_exists($file_dir)) {
                return Response::json(array('code' => 201, 'message' => 'Design page already exist on this path.', 'cause' => '', 'data' => json_decode("{}")));
            }
            ...
            if(substr_count($page_url,"/") > 2) {
                ...
                if(!file_exists($parent_folder_path)) {
                    return Response::json(array('code' => 201, 'message' => 'index.html does not exist in parent folder.', 'cause' => '', 'data' => json_decode("{}")));
                }
            }

            $response = Response::json(array('code' => 200, 'message' => 'URL verified successfully.', 'cause' => '', 'data' => json_decode("{}")));

        } catch (Exception $e) {
            (new ImageController())->logs("verifyURLForDesignPageCreation",$e);
            //Log::error("verifyURLForDesignPageCreation : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'verified URL.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
        }
        return $response;
    }
    ...
    public function setChangesInDesignPageV2(Request $request_body)
    {
        try {
            ...
            $response = Response::json(array('code' => 200, 'message' => 'File updated successfully.', 'cause' => '', 'data' => json_decode("{}")));
    ...
    public function setChangesInDesignPage(Request $request_body)
    {
        try {
            ...
            $request = json_decode($request_body->getContent());
            if (($response = (new VerificationController())->validateRequiredParameter(array('page_url', 'zip_url'), $request)) != '')
                return $response;
    ...
    public function getDesignPageChangesList(Request $request_body)
    {
        try {
            ...
            $response = Response::json(array('code' => 200, 'message' => 'Changes list fetch successfully.', 'cause' => '', 'data' => $redis_result));
    ...
    public function getDesignFileContent(Request $request_body)
    {
        try {
            ...
            if(file_exists($file_dir)) {
                ...
                $response = Response::json(array('code' => 200, 'message' => 'Content list fetch successfully.', 'cause' => '', 'data' => $redis_result));

            }else{
                $response = Response::json(array('code' => 404, 'message' => 'File not found.', 'cause' => '', 'data' => json_decode("{}")));
            }
    ...
    public function getDesignPageJsonList(Request $request_body)
    {
        try {
            ...
            $request = json_decode($request_body->getContent());
            if (($response = (new VerificationController())->validateRequiredParameter(array('page', 'item_count', 'content_type'), $request)) != '')
                return $response;
            ...
            $response = Response::json(array('code' => 200, 'message' => 'Design page json list fetch successfully.', 'cause' => '', 'data' => $redis_result));
    ...
    public function generateAllDesignPageByAdmin()
    {
        ...
        try {
            ...
            if (Cache::has("$this->api_name")) {
                $response = Response::json(array('code' => 200, 'message' => 'There are no any changes for generate pages.', 'cause' => '', 'data' => 0));
                ...
                $response = Response::json(array('code' => 200, 'message' => 'Design pages generated successfully.', 'cause' => '', 'data' => $redis_result));
            }

        } catch (Exception $e) {
            (new ImageController())->logs($this->api_name, $e);
            //Log::error($this->api_name . " : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'generate design page.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
        }
        return $response;
    }
  ...
  public function addCtaDetailInDesignPage()
  {
    try {
      ...
      DB::commit();
      $response = Response::json(array('code' => 200, 'message' => 'CTA detail added in design page successfully.', 'cause' => '', 'data' => json_decode("{}"), 'counter' => $counter));

    } catch (Exception $e) {
      (new ImageController())->logs("addCtaDetailInDesignPage", $e);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'add cta detail in design page.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
    ...
    public function generateDesignPageByAdmin(Request $request_body)
    {
        ...
        try {
            ...
            $request = json_decode($request_body->getContent());
            if (($response = (new VerificationController())->validateRequiredParameter(array('page_url', 'json_data', 'content_type'), $request)) != '')
                return $response;
            ...
            if (strlen($request->page_url) == strlen($page_url)) {
                ...
                return Response::json(array('code' => 201, 'message' => 'Something went wrong.', 'cause' => '', 'data' => json_decode("{}")));
            }

            DB::beginTransaction();

            $uuid = (new ImageController())->generateUUID();
            $design_page_data = array(
                'uuid' => $uuid,
            ...
            $response = Response::json(array('code' => 200, 'message' => 'Design page generated successfully.', 'cause' => '', 'data' => json_decode("{}")));
            ...
            (new ImageController())->logs($this->api_name, $e);
            //Log::error($this->api_name . " : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'generate static page.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
        }
        return $response;
    }
    ...
    public function editDesignPageByAdmin(Request $request_body)
    {
        ...
        try {
            ...
            $request = json_decode($request_body->getContent());
            if (($response = (new VerificationController())->validateRequiredParameter(array('id', 'page_url', 'json_data', 'content_type'), $request)) != '')
                return $response;
            ...
            (new ImageController())->logs($this->api_name, $e);
            Log::error($this->api_name . " : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'edit design page.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
        }
        return $response;
    }
    ...
    public function moveDesignPageByAdmin(Request $request_body)
    {
        ...
        try {
            ...
            $request = json_decode($request_body->getContent());
            if (($response = (new VerificationController())->validateRequiredParameter(array('id', 'old_page_url', 'new_page_url', 'content_type'), $request)) != '')
                return $response;
            ...
            $response = Response::json(array('code' => 200, 'message' => 'Design page moved successfully.', 'cause' => '', 'data' => json_decode("{}")));
            ...
            (new ImageController())->logs($this->api_name, $e);
            //Log::error($this->api_name . " : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'moved design page.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
        }
        return $response;
    }
    ...
    public function previewDesignPageByAdmin(Request $request_body)
    {
        try {
            ...
            $request = json_decode($request_body->getContent());
            if (($response = (new VerificationController())->validateRequiredParameter(array('json_data', 'content_type'), $request)) != '')
                return $response;
            ...
            $response = Response::json(array('code' => 200, 'message' => 'Design page previewed successfully.', 'cause' => '', 'data' => $html));

        } catch (Exception $e) {
            (new ImageController())->logs("previewDesignPageByAdmin", $e);
            //Log::error("previewDesignPageByAdmin : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'previewed design page.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
        }
        return $response;
    }
  ...
  public function getUserRecords(Request $request_body)
  {
    try {
      ...
      return array('total_users'=>$total_record, 'users_detail'=>$users);
    } catch (Exception $e) {
...
//      Log::error("runArtisanCommands : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
  ...
  public function deleteFileListFromS3(Request $request_body)
  {
    try {
      ...
      $response = Response::json(array('code' => 201, 'message' => 's3 file fetch successfully.', 'cause' => '', 'data' => ['all_files' => $all_files]));
  ...
  public function addCacheControlInToS3Object(Request $request_body)
  {
    try {
      ...
      $request = json_decode($request_body->getContent());
      if (($response = (new VerificationController())->validateRequiredParameter(array('file_name','folder_name','content_type'), $request)) != '')
        return $response;
      ...
      */
      ...
      try {
        ...
        $response = Response::json(array('code' => 200, 'message' => "Cache-control added successfully. $is_cdn_error", 'cause' => "", 'data' => json_decode("{}")));
        ...
        $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . ' add cache control.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      }
...
//      Log::error("addCacheControlInToS3Object : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
    ...
    public function getAllLocalFile(Request $request_body)
    {
        try {
            ...
            $request = json_decode($request_body->getContent());
            if (($response = (new VerificationController())->validateRequiredParameter(array('path'), $request)) != '')
                return $response;

            $path = $request->path;
            $all_files = array_diff(scandir($path), array('.', '..'));

            $response = Response::json(array('code' => 200, 'message' => 'All files fetch successfully.', 'cause' => '', 'data' => $all_files));
    ...
    public function deleteLocalFileByFileName(Request $request_body)
    {
        try {
            ...
            $response = Response::json(array('code' => 200, 'message' => 'Files deleted successfully.', 'cause' => '', 'data' => json_decode("{}")));
...
//                            tag IN ("'.$search_category_string.'") ',[count($img_id_array)]);
  ...
  public function updateMultipleTemplateNameByAdmin(Request $request_body)
    {
        try {
            ...
            $request = json_decode($request_body->getContent());
            if(($response = (new VerificationController())->validateRequiredParameterIsArray(array('content_details'), $request)) != '')
                return $response;
            ...
            $response = Response::json(array('code' => 200, 'message' => 'Template name updated successfully.', 'cause' => '', 'data' => json_decode("{}")));

        } catch (Exception $e) {
            Log::error("updateMultipleTemplateNameByAdmin : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'update template name.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
        }
        return $response;
    }
  ...
  public function updateMultipleTemplateByAdmin(Request $request_body)
  {
    try {
      ...
      $request = json_decode($request_body->getContent());
      if (($response = (new VerificationController())->validateRequiredParameter(array('catalog_id', 'content_ids'), $request)) != '')
        return $response;
  ...
  public function updateMultipleCatalogByAdmin(Request $request_body)
  {
    try {
      ...
      $request = json_decode($request_body->getContent());
      if (($response = (new VerificationController())->validateRequiredParameter(array('catalog_ids', 'sub_category_id'), $request)) != '')
        return $response;
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Multiple catalog updated successfully.', 'cause' => '', 'data' => json_decode("{}")));

    } catch (Exception $e) {
      Log::error("updateMultipleCatalogByAdmin : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'update multiple catalog.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
  ...
  public function deleteMultipleTemplateByAdmin(Request $request_body)
  {
    try {
      ...
      if(count($detail) > 0){
        $response = Response::json(array('code' => 201, 'message' => 'You are trying to delete templates which are exist in static page.', 'cause' => '', 'data' => json_decode('{}')));
        return $response;
      }
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Multiple templates deleted successfully.', 'cause' => '', 'data' => json_decode("{}")));

    } catch (Exception $e) {
      Log::error("deleteMultipleTemplateByAdmin : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'delete multiple templates.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
  ...
  public function emailNotifications(Request $request_body)
  {
    try {
      ...
      if (count($result)) {
        ...
        $response = Response::json(array('code' => 200, 'message' => 'Notification data updated successfully.', 'cause' => '', 'data' => json_decode("{}")));
      } else {
        ...
        $response = Response::json(array('code' => 200, 'message' => 'Notification data inserted successfully.', 'cause' => '', 'data' => json_decode("{}")));
      }
      DB::commit();

    } catch (Exception $e) {
      (new ImageController())->logs("emailNotifications", $e);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'manage notification data.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
      DB::rollBack();
    }
    return $response;
  }
  ...
  public function removeDuplicateTag(Request $request_body)
  {
    try {
      ...
      DB::commit();
      $response = Response::json(array('code' => 201, 'message' => 'Duplicate tag remove successfully.', 'cause' => '', 'data' => $counter));

    } catch (Exception $e) {
      (new ImageController())->logs("removeDuplicateTag", $e);
      //Log::error("removeDuplicateTag : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      $response = Response::json(array('code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR') . 'duplicate tag.', 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
    return $response;
  }
  ...
  public function addCatalogIdInDesignPage(Request $request_body)
  {
    try {
      ...
      $request = json_decode($request_body->getContent());
      if (($response = (new VerificationController())->validateRequiredParameter(array('content_type'), $request)) != '')
        return $response;
      ...
      $response = Response::json(array('code' => 200, 'message' => 'Catalog id added successfully in design page.', 'cause' => '', 'data' => json_decode("{}"), 'counter' => $counter));
