...
class PaymentModuleController extends Controller
{
    ...
    public function createProduct(Request $request_body)
    {
        try {
            ...
            if (($response = (new VerificationController())->validateRequiredParameter(['name', 'discount_percentage'], $request)) != '') {
                return $response;
            }
            ...
            $response = Response::json(['code' => 200, 'message' => 'Product added successfully.', 'cause' => '', 'data' => json_decode('{}')]);
        } catch (Exception $e) {
            (new ImageController())->logs('createProduct', $e);
            //      Log::error("createProduct : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'add product.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
            DB::rollBack();
        }
    ...
    public function updateProduct(Request $request_body)
    {
        try {
            ...
            $request = json_decode($request_body->getContent());
            if (($response = (new VerificationController())->validateRequiredParameter(['product_id', 'name', 'discount_percentage', 'is_applied'], $request)) != '') {
                return $response;
            }
            ...
            if (isset($request->is_update_pricing)) {
                if (($result = (new verificationController())->UpdatePricingByProductId($product_id, $discount_percentage)) != 1) {
                    return Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'update pricing by product.', 'cause' => '', 'data' => json_decode('{}')]);
                }
            }
            ...
            $response = Response::json(['code' => 200, 'message' => 'Product updated successfully.', 'cause' => '', 'data' => json_decode('{}')]);
        } catch (Exception $e) {
    ...
    public function deleteProduct(Request $request_body)
    {
        try {
            ...
            $request = json_decode($request_body->getContent());
            if (($response = (new VerificationController())->validateRequiredParameter(['product_id'], $request)) != '') {
                return $response;
            }
            ...
            $response = Response::json(['code' => 200, 'message' => 'Product deleted successfully.', 'cause' => '', 'data' => json_decode('{}')]);
        } catch (Exception $e) {
    ...
    public function getAllProducts(Request $request_body)
    {
        try {
            ...
            $response = Response::json(['code' => 200, 'message' => 'All products fetched successfully.', 'cause' => '', 'data' => ['result' => $redis_result]]);
            $response->headers->set('Cache-Control', Config::get('constant.RESPONSE_HEADER_CACHE'));

        } catch (Exception $e) {
            (new ImageController())->logs('getAllCategory', $e);
            //      Log::error("getAllCategory : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'get all products.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
        }
    ...
    public function addPricingToProduct(Request $request_body)
    {
        try {
            ...
            $request = json_decode($request_body->getContent());
            if (($response = (new VerificationController())->validateRequiredParameter(['product_id', 'plan_interval', 'plan_title', 'button_id', 'fs_product_id', 'actual_amount', 'payable_amount', 'actual_amount_inr', 'payable_amount_inr', 'currency', 'is_active'], $request)) != '') {
                return $response;
            }
            ...
            if (($plan_id = (new verificationController())->getPlanIdFromPlanName($plan_interval, $plan_title)) == 0) {
                return Response::json(['code' => 201, 'message' => 'Selected plan not registered, contact admin to add your plan.', 'cause' => '', 'data' => json_decode('{}')]);
            }
            ...
            if (count($verify_button) > 0) {
                return Response::json(['code' => 201, 'message' => 'The same button ID has already been added to another plan, please check again.', 'cause' => '', 'data' => json_decode('{}')]);
            }
            ...
            $response = Response::json(['code' => 200, 'message' => 'Pricing added successfully.', 'cause' => '', 'data' => json_decode('{}')]);
        } catch (Exception $e) {
            (new ImageController())->logs('addPricingToProduct', $e);
            //      Log::error("addPricingToProduct : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'add pricing.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
            DB::rollBack();
        }
    ...
    public function updatePricingToProduct(Request $request_body)
    {
        try {
            ...
            $request = json_decode($request_body->getContent());
            if (($response = (new VerificationController())->validateRequiredParameter(['pricing_id', 'product_id', 'plan_interval', 'plan_title', 'button_id', 'fs_product_id', 'actual_amount', 'payable_amount', 'actual_amount_inr', 'payable_amount_inr', 'currency', 'is_active'], $request)) != '') {
                return $response;
            }
            ...
            $response = Response::json(['code' => 200, 'message' => 'Pricing updated successfully.', 'cause' => '', 'data' => json_decode('{}')]);
        } catch (Exception $e) {
            (new ImageController())->logs('updatePricingToProduct', $e);
            //      Log::error("updatePricingToProduct : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'update444 pricing.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
            DB::rollBack();
        }
    ...
    public function deletePricingToProduct(Request $request_body)
    {
        try {
            ...
            $request = json_decode($request_body->getContent());
            if (($response = (new VerificationController())->validateRequiredParameter(['pricing_id'], $request)) != '') {
                return $response;
            }
            ...
            $response = Response::json(['code' => 200, 'message' => 'Pricing deleted successfully.', 'cause' => '', 'data' => json_decode('{}')]);
        } catch (Exception $e) {
            (new ImageController())->logs('deletePricingToProduct', $e);
            //      Log::error("deletePricingToProduct : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'delete pricing.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
            DB::rollBack();
        }
    ...
    public function getPricingByProduct(Request $request_body)
    {
        try {
            ...
            $response = Response::json(['code' => 200, 'message' => 'All pricing fetched successfully.', 'cause' => '', 'data' => ['result' => $redis_result]]);
            $response->headers->set('Cache-Control', Config::get('constant.RESPONSE_HEADER_CACHE'));

        } catch (Exception $e) {
            (new ImageController())->logs('getPricingByProduct', $e);
            //      Log::error("getPricingByProduct : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'get pricing by products.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
        }
    ...
    public function getCouponFromStripe(Request $request_body)
    {
        try {
            ...
            $response = Response::json(['code' => 200, 'message' => 'Coupons details fetched successfully.', 'cause' => '', 'data' => ['coupon_detail' => $coupons]]);
        } catch (Exception $e) {
            (new ImageController())->logs('getCouponFromStripe', $e);
            //      Log::error("getCouponFromStripe : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'fetch coupons details.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
            DB::rollBack();
        }
    ...
    public function getPricingByUser(Request $request_body)
    {
        try {
            ...
            if (! $redis_result) {
                return Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'get product details.', 'cause' => '', 'data' => json_decode('{}')]);
            }

            $user_detail = (new LoginController())->getUserInfoByUserId($this->user_id);
            $redis_result->user_detail = $user_detail;
            $response = Response::json(['code' => 200, 'message' => 'Pricing fetched successfully.', 'cause' => '', 'data' => ['result' => $redis_result]]);
            $response->headers->set('Cache-Control', Config::get('constant.RESPONSE_HEADER_CACHE'));
