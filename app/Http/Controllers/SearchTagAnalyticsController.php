...
class SearchTagAnalyticsController extends Controller
{
  ...
  public function getSearchAnalytics(Request $request_body){
    try{
      ...
      if (($response = (new VerificationController())->validateRequiredParameter(array('date','item_count'), $request)) != '')
        return $response;
      ...
      return Response::json(array('code' => 200, 'message' => 'Get search analytics successfully.', 'cause' =>"", 'data' => $data));
    } catch (Exception $e) {
      (new ImageController())->logs("getSearchAnalytics",$e);
//      Log::error("getSearchAnalytics : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
      return Response::json(array('code' => 201, 'message' =>Config('constants.EXCEPTION_ERROR')." get search analitics", 'cause' => $e->getMessage(), 'data' => json_decode("{}")));
    }
  }
