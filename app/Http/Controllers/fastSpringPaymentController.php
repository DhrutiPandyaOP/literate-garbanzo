    ...
    */
    public function setFastSpringPaymentMethod(Request $request_body)
    {
        ...
        try {
            ...
            if (($response = (new VerificationController())->validateRequiredParameter(['order_id', 'product_id', 'total_amount', 'tax_amount'], $request)) != '') {
                return $response;
            }
            ...
            try {
                ...
                return Response::json(['code' => 201, 'message' => $error_msg->orders[0]->error->order, 'cause' => '', 'data' => json_decode('{}')]);
            }
            ...
            if (count($subscription_detail) <= 0) {
                ...
                return Response::json(['code' => 200, 'message' => 'Thank you, your payment was successful.', 'cause' => '', 'data' => ['user_detail' => $user_detail]]);
            ...
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'set payment method.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
        }
    ...
    public function cancelFastSpringSubscription(Request $request_body)
    {
        ...
        try {
            ...
            if (count($subscription_detail) <= 0) {
                ...
                return Response::json(['code' => 201, 'message' => 'Subscriptions does not exist.', 'cause' => '', 'data' => json_decode('{}')]);
            ...
            try {
                ...
                return Response::json(['code' => 201, 'message' => $message, 'cause' => '', 'data' => json_decode('{}')]);
            }
            ...
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'cancel fast spring subscription.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
            DB::rollBack();
        }
    ...
    */
    public function getFastSpringUserOrdersURL(Request $request_body)
    {
        ...
        try {
            ...
            $response = Response::json(['code' => 200, 'message' => 'User order url fetch successfully.', 'cause' => '', 'data' => $result]);

        } catch (Exception $e) {
            (new ImageController())->logs('getFastSpringUserOrdersURL', $e);
            //Log::error("getFastSpringUserOrdersURL : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'get order url.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
            DB::rollBack();
        }
    ...
    */
    public function subscriptionActivatedEvent(Request $request_body)
    {
        ...
        try {
            ...
            $response = Response::json(['code' => 200, 'message' => 'Subscription activated event processed successfully.', 'cause' => '', 'data' => json_decode('{}')]);

        } catch (Exception $e) {
            (new ImageController())->logs('subscriptionActivatedEvent', $e);
            //Log::error("subscriptionActivatedEvent : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'fired subscription activated event.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
            DB::rollBack();
        }
        ...
        try {
            ...
            foreach ($events as $i => $events) {
                ...
                if (isset($user_profile[0]->user_id)) {
                    ...
                    return Response::json(['code' => 201, 'message' => 'User does not exist.', 'cause' => '', 'data' => json_decode('{}')]);
                }
            ...
            $response = Response::json(['code' => 200, 'message' => 'Order completed event processed successfully.', 'cause' => '', 'data' => json_decode('{}')]);

        } catch (Exception $e) {
            (new ImageController())->logs('orderCompletedEvent', $e);
            //Log::error("orderCompletedEvent : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'fired order completed event.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
            DB::rollBack();
        }
    ...
    */
    public function orderFailedEvent(Request $request_body)
    {
        ...
        try {
            ...
            $response = Response::json(['code' => 200, 'message' => 'Order failed event process successfully.', 'cause' => '', 'data' => json_decode('{}')]);

        } catch (Exception $e) {
            (new ImageController())->logs('orderFailedEvent', $e);
            //Log::error("orderFailedEvent : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'fired order failed event.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
            DB::rollBack();
        }
    ...
    */
    public function subscriptionCanceledEvent(Request $request_body)
    {
        ...
        try {
            ...
            $response = Response::json(['code' => 200, 'message' => 'subscription canceled event processed successfully.', 'cause' => '', 'data' => json_decode('{}')]);

        } catch (Exception $e) {
            (new ImageController())->logs('subscriptionCanceledEvent', $e);
            //Log::error("subscriptionCanceledEvent : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'fired subscription canceled event.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
            DB::rollBack();
        }
    ...
    */
    public function subscriptionUncanceledEvent(Request $request_body)
    {
        ...
        try {
            ...
            $response = Response::json(['code' => 200, 'message' => 'subscription uncanceled event processed successfully.', 'cause' => '', 'data' => json_decode('{}')]);

        } catch (Exception $e) {
            (new ImageController())->logs('subscriptionUncanceledEvent', $e);
            //Log::error("subscriptionUncanceledEvent : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'fired subscription uncanceled event.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
            DB::rollBack();
        }
    ...
    public function subscriptionDeactivatedEvent(Request $request_body)
    {
        try {
            ...
            if (Config::get('constant.ACTIVATION_LINK_PATH') != 'https://test.photoadking.com') {
                return Response::json(['code' => 201, 'message' => 'Live user are not allowed to use this webhook.', 'cause' => '', 'data' => json_decode('{}')]);
            }
            ...
            $response = Response::json(['code' => 200, 'message' => 'Subscription deactivated event processed successfully.', 'cause' => '', 'data' => json_decode('{}')]);

        } catch (Exception $e) {
            (new ImageController())->logs('subscriptionDeactivatedEvent', $e);
            //Log::error("subscriptionDeactivatedEvent : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'fired subscription deactivated event.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
            DB::rollBack();
        }
...
Thanks for renewing the subscription for <b>'.$subscription_name.'</b>. We hope you are enjoying the PhotoADKing.',
            ...
            $response = Response::json(['code' => 200, 'message' => 'subscription charge completed event process successfully.', 'cause' => '', 'data' => json_decode('{}')]);
            ...
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'fired subscription charge completed event.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
            DB::rollBack();
        }
    ...
    */
    public function subscriptionChargeFailedEvent(Request $request_body)
    {
        ...
        try {
            ...
            $response = Response::json(['code' => 200, 'message' => 'subscription charge failed event process successfully.', 'cause' => '', 'data' => json_decode('{}')]);

        } catch (Exception $e) {
            (new ImageController())->logs('subscriptionChargeFailedEvent', $e);
            //Log::error("subscriptionChargeFailedEvent : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'fired subscription charge failed event.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
            DB::rollBack();
        }
    ...
    */
    public function returnCreatedEvent(Request $request_body)
    {
        ...
        try {
            ...
            $response = Response::json(['code' => 200, 'message' => 'return created event processed successfully.', 'cause' => '', 'data' => json_decode('{}')]);

        } catch (Exception $e) {
            (new ImageController())->logs('returnCreatedEvent', $e);
            //Log::error("returnCreatedEvent : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'fired return created event.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
            DB::rollBack();
        }
    ...
    public function getDaysAndTypeOfPayment($product_id)
    {
        try {
            ...
            $response = ['add_days' => $add_days, 'subscr_type' => $subscr_type, 'add_month' => $add_month];

        } catch (Exception $e) {
            (new ImageController())->logs('getDaysAndTypeOfPayment', $e);
            //Log::error("getDaysAndTypeOfPayment : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = ['add_days' => 0, 'subscr_type' => 0, 'add_month' => 0];
        }
    ...
    public function validateWebHookEvents($request_body)
    {
        ...
        try {
            ...
            if ($hash_key != $request_body->header('X-Fs-Signature')) {
                ...
                return Response::json(['code' => 201, 'message' => 'Sorry, Your token is invalid.', 'cause' => '', 'data' => json_decode('{}')]);
            }

            $request = json_decode($request_body->getContent());
            if (($response = (new VerificationController())->validateRequiredParameterIsArray(['events'], $request)) != '') {
            ...
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'validate webhook event.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
            DB::rollBack();
        }
    ...
    public function orderCanceledEvent(Request $request_body)
    {
        ...
        try {
            ...
            $response = Response::json(['code' => 200, 'message' => 'order canceled event processed successfully.', 'cause' => '', 'data' => json_decode('{}')]);

        } catch (Exception $e) {
            (new ImageController())->logs('orderCanceledEvent', $e);
            //Log::error("orderPaymentPendingEvent : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'fired order canceled event.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
            DB::rollBack();
        }
    ...
    public function orderPaymentPendingEvent(Request $request_body)
    {
        ...
        try {
            ...
            $response = Response::json(['code' => 200, 'message' => 'order payment pending event processed successfully.', 'cause' => '', 'data' => json_decode('{}')]);

        } catch (Exception $e) {
            (new ImageController())->logs('orderPaymentPendingEvent', $e);
            //Log::error("orderPaymentPendingEvent : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'fired order payment pending event.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
            DB::rollBack();
        }
    ...
    public function orderApprovalPendingEvent(Request $request_body)
    {
        ...
        try {
            ...
            $response = Response::json(['code' => 200, 'message' => 'order approval pending event processed successfully.', 'cause' => '', 'data' => json_decode('{}')]);

        } catch (Exception $e) {
            (new ImageController())->logs('orderApprovalPendingEvent', $e);
            //Log::error("orderApprovalPendingEvent : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'fired order approval pending event.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
            DB::rollBack();
        }
    ...
    public function fulfillmentFailedEvent(Request $request_body)
    {
        ...
        try {
            ...
            $response = Response::json(['code' => 200, 'message' => 'fulfillment failed event processed successfully.', 'cause' => '', 'data' => json_decode('{}')]);

        } catch (Exception $e) {
            (new ImageController())->logs('fulfillmentFailedEvent', $e);
            //Log::error("fulfillmentFailedEvent : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'fired fulfillment failed event.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
            DB::rollBack();
        }
    ...
    public function subscriptionUpdatedEvent(Request $request_body)
    {
        ...
        try {
            ...
            $response = Response::json(['code' => 200, 'message' => 'subscription updated event processed successfully.', 'cause' => '', 'data' => json_decode('{}')]);

        } catch (Exception $e) {
            (new ImageController())->logs('subscriptionUpdatedEvent', $e);
            //Log::error("subscriptionUpdatedEvent : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'fired subscription updated event.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
            DB::rollBack();
        }
    ...
    public function subscriptionTrialReminderEvent(Request $request_body)
    {
        ...
        try {
            ...
            $response = Response::json(['code' => 200, 'message' => 'subscription trial reminder event processed successfully.', 'cause' => '', 'data' => json_decode('{}')]);

        } catch (Exception $e) {
            (new ImageController())->logs('subscriptionTrialReminderEvent', $e);
            //Log::error("subscriptionTrialReminderEvent : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'fired subscription trial reminder event.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
            DB::rollBack();
        }
    ...
    public function subscriptionPaymentReminderEvent(Request $request_body)
    {
        ...
        try {
            ...
            $response = Response::json(['code' => 200, 'message' => 'subscription payment reminder event processed successfully.', 'cause' => '', 'data' => json_decode('{}')]);
            ...
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'fired subscription payment reminder event.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
            DB::rollBack();
        }
    ...
    public function subscriptionPaymentOverdueEvent(Request $request_body)
    {
        ...
        try {
            ...
            $response = Response::json(['code' => 200, 'message' => 'subscription payment overdue event processed successfully.', 'cause' => '', 'data' => json_decode('{}')]);
            ...
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'fired subscription payment overdue event.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
            DB::rollBack();
        }
    ...
    public function invoiceReminderEmailEvent(Request $request_body)
    {
        ...
        try {
            ...
            $response = Response::json(['code' => 200, 'message' => 'invoice reminder email event processed successfully.', 'cause' => '', 'data' => json_decode('{}')]);

        } catch (Exception $e) {
            (new ImageController())->logs('invoiceReminderEmailEvent', $e);
            //Log::error("invoiceReminderEmailEvent : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'fired invoice reminder email event.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
            DB::rollBack();
        }
    ...
    public function mailingListEntryUpdatedEvent(Request $request_body)
    {
        ...
        try {
            ...
            $response = Response::json(['code' => 200, 'message' => 'mailing list entry updated event processed successfully.', 'cause' => '', 'data' => json_decode('{}')]);

        } catch (Exception $e) {
            (new ImageController())->logs('mailingListEntryUpdatedEvent', $e);
            //Log::error("mailingListEntryUpdatedEvent : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'fired mailing list entry updated event.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
            DB::rollBack();
        }
    ...
    public function mailingListEntryAbandonedEvent(Request $request_body)
    {
        ...
        try {
            ...
            $response = Response::json(['code' => 200, 'message' => 'mailing list entry abandoned event processed successfully.', 'cause' => '', 'data' => json_decode('{}')]);

        } catch (Exception $e) {
            (new ImageController())->logs('mailingListEntryAbandonedEvent', $e);
            //Log::error("mailingListEntryAbandonedEvent : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'fired mailing list entry abandoned event.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
            DB::rollBack();
        }
    ...
    public function mailingListEntryRemovedEvent(Request $request_body)
    {
        ...
        try {
            ...
            $response = Response::json(['code' => 200, 'message' => 'mailing list entry removed event processed successfully.', 'cause' => '', 'data' => json_decode('{}')]);

        } catch (Exception $e) {
            (new ImageController())->logs('mailingListEntryRemovedEvent', $e);
            //Log::error("mailingListEntryRemovedEvent : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'fired mailing list entry removed event.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
            DB::rollBack();
        }
    ...
    public function accountCreatedEvent(Request $request_body)
    {
        ...
        try {
            ...
            $response = Response::json(['code' => 200, 'message' => 'account created event processed successfully.', 'cause' => '', 'data' => json_decode('{}')]);

        } catch (Exception $e) {
            (new ImageController())->logs('accountCreatedEvent', $e);
            //Log::error("accountCreatedEvent : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'fired account Created event.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
            DB::rollBack();
        }
    ...
    public function accountUpdatedEvent(Request $request_body)
    {
        ...
        try {
            ...
            $response = Response::json(['code' => 200, 'message' => 'account updated event processed successfully.', 'cause' => '', 'data' => json_decode('{}')]);

        } catch (Exception $e) {
            (new ImageController())->logs('accountUpdatedEvent', $e);
            //Log::error("accountUpdatedEvent : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'fired account updated event.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
            DB::rollBack();
        }
    ...
    public function payoutEntryCreatedEvent(Request $request_body)
    {
        ...
        try {
            ...
            $response = Response::json(['code' => 200, 'message' => 'payout entry created event processed successfully.', 'cause' => '', 'data' => json_decode('{}')]);

        } catch (Exception $e) {
            (new ImageController())->logs('payoutEntryCreatedEvent', $e);
            //Log::error("payoutEntryCreatedEvent : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'fired payout entry created event.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
            DB::rollBack();
        }
    ...
    public function quoteCreatedEvent(Request $request_body)
    {
        ...
        try {
            ...
            $response = Response::json(['code' => 200, 'message' => 'quote created event processed successfully.', 'cause' => '', 'data' => json_decode('{}')]);

        } catch (Exception $e) {
            (new ImageController())->logs('quoteCreatedEvent', $e);
            //Log::error("quoteCreatedEvent : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'fired quote created event.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
            DB::rollBack();
        }
    ...
    public function quoteUpdatedEvent(Request $request_body)
    {
        ...
        try {
            ...
            $response = Response::json(['code' => 200, 'message' => 'quote updated event processed successfully.', 'cause' => '', 'data' => json_decode('{}')]);

        } catch (Exception $e) {
            (new ImageController())->logs('quoteUpdatedEvent', $e);
            //Log::error("quoteUpdatedEvent : ", ["Exception" => $e->getMessage(), "\nTraceAsString" => $e->getTraceAsString()]);
            $response = Response::json(['code' => 201, 'message' => Config::get('constant.EXCEPTION_ERROR').'fired quote updated event.', 'cause' => $e->getMessage(), 'data' => json_decode('{}')]);
            DB::rollBack();
        }
